...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 320 · 🔀 3.7K · 📦 70K · ⏱️ 01.06.2025)
...
- [GitHub](https://github.com/FernandoCelmer/mkdocs-simple-blog) (👨‍💻 3 · 🔀 8 · 📦 92 · 📋 26 - 30% open · ⏱️ 23.03.2025)
...
<details><summary><b><a href="https://github.com/ntno/mkdocs-terminal">Terminal for MkDocs</a></b>  - 🥈17 ·  ⭐ 260 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1495/PNG/32/preferencesdesktoptheme_102980.png" style="display:inline;" width="13" height="13"></code><br>monospace theme for MkDocs.</summary>
...
- [PyPi](https://pypi.org/project/mkdocs-terminal) (📥 6.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-torillic) (📥 120 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-curriculum-vitae) (📥 140 / month):
	```
...
<details><summary><b><a href="https://github.com/wsoft-ws/lantana">Lantana</a></b>  - 🥈11 ·  ⭐ 20 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1495/PNG/32/preferencesdesktoptheme_102980.png" style="display:inline;" width="13" height="13"></code><br>Lantana MKDocsHTML.</summary>
...
- [PyPi](https://pypi.org/project/lantana) (📥 150 / month):
	```
	pip install lantana
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (🔀 2 · 📦 2 · 📋 2 - 50% open · ⏱️ 21.05.2025)
- [PyPi](https://pypi.org/project/mkdocs-shadcn) (📥 500 / month):
	```
...
<details><summary><b><a href="https://github.com/noraj/mkdocs-windmill-dark">Windmill Dark</a></b>  - 🥉8 ·  ⭐ 35 · 💤 · <code>❗Unlicensed</code> · <code><img src="https://cdn.icon-icons.com/icons2/1495/PNG/32/preferencesdesktoptheme_102980.png" style="display:inline;" width="13" height="13"></code><br>Outstanding mkdocs theme with a focus on navigation and usability.</summary>
...
- [PyPi](https://pypi.org/project/mkdocs-gitbook) (📥 23K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-topdf) (📥 46 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-risonia-theme) (📥 17 / month):
	```
...
- [GitHub](https://github.com/mkdocstrings/python) (👨‍💻 27 · 🔀 45 · 📋 190 - 19% open · ⏱️ 03.06.2025)
...
- [GitHub](https://github.com/mkdocs/mkdocs-click) (👨‍💻 15 · 🔀 19 · 📦 870 · 📋 32 - 50% open · ⏱️ 13.04.2025)
...
- [GitHub](https://github.com/Neoteroi/mkdocs-plugins) (👨‍💻 10 · 🔀 7 · 📥 8.9K · 📦 410 · 📋 43 - 41% open · ⏱️ 22.04.2025)
...
- [GitHub](https://github.com/JakubAndrysek/MkDoxy) (👨‍💻 17 · 🔀 23 · 📦 43 · 📋 66 - 27% open · ⏱️ 15.01.2025)
...
- [GitHub](https://github.com/mkdocstrings/crystal) (👨‍💻 3 · 🔀 3 · 📦 960 · 📋 5 - 80% open · ⏱️ 15.02.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-autoapi) (📥 6.2K / month):
	```
...
- [GitHub](https://github.com/tlambert03/mkdocs-api-autonav) (👨‍💻 2 · 🔀 1 · 📥 37 · 📦 23 · 📋 10 - 10% open · ⏱️ 18.05.2025)
- [PyPi](https://pypi.org/project/mkdocs-api-autonav) (📥 23K / month):
	```
...
<details><summary><b><a href="https://github.com/mkdocstrings/shell">mkdocstrings-shell</a></b>  - 🥉12 ·  ⭐ 4 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code><br>A shell scripts/libraries handler for mkdocstrings.</summary>
...
- [PyPi](https://pypi.org/project/mkdocs-material-adr) (📥 950 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-apidescribed-plugin) (📥 1.3K / month):
	```
...
- [PyPi](https://pypi.org/project/automacdoc) (📥 46 / month):
	```
...
- [PyPi](https://pypi.org/project/inari) (📥 57 / month):
	```
	pip install inari
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/Guts/mkdocs-rss-plugin) (👨‍💻 19 · 🔀 28 · 📥 220 · 📦 1.2K · 📋 56 - 25% open · ⏱️ 02.06.2025)
- [PyPi](https://pypi.org/project/mkdocs-rss-plugin) (📥 71K / month):
	```
...
- [PyPi](https://pypi.org/project/plantuml-markdown) (📥 570K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-glightbox) (📥 560K / month):
	```
...
- [GitHub](https://github.com/AVATEAM-IT-SYSTEMHAUS/mkdocs-kroki-plugin) (👨‍💻 16 · 🔀 27 · 📦 64 · 📋 41 - 17% open · ⏱️ 28.07.2024)
- [PyPi](https://pypi.org/project/mkdocs-kroki-plugin) (📥 39K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-badges) (📥 5.6K / month):
	```
...
- [PyPi](https://pypi.org/project/docutools) (📥 94 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-wavedrom-plugin) (📥 71 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-svgbob) (📥 440 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bpmn-js) (📥 180 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-thumbnails) (📥 93 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-figcap) (📥 44 / month):
	```
...
- [GitHub](https://github.com/pawamoy/markdown-exec) (👨‍💻 4 · 🔀 12 · 📦 530 · 📋 66 - 25% open · ⏱️ 24.03.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 460K / month):
	```
...
- [PyPi](https://pypi.org/project/mkjsfiddle) (📥 31 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nbconvert) (📥 250 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-entangled-plugin) (📥 77 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-data-plugin) (📥 81 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-protobuf) (📥 64 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-localized-plugin) (📥 960K / month):
	```
...
- [GitHub](https://github.com/timvink/mkdocs-git-authors-plugin) (👨‍💻 16 · 🔀 23 · 📦 1.6K · 📋 65 - 13% open · ⏱️ 22.04.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-git-committers-plugin-2) (📥 91K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-latest-changes-plugin) (📥 15K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github-changelog) (📥 130 / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 📦 70 · ⏱️ 02.06.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-link-embeds-plugin) (📥 280 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extra-sass-plugin) (📥 6.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ai-summary) (📥 28 / month):
	```
...
<details><summary><b><a href="https://github.com/blueswen/mkdocs-swagger-ui-tag">MkDocs Swagger UI Tag</a></b>  - 🥇20 ·  ⭐ 94 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>A MkDocs plugin supports adding Swagger UI to the page.</summary>

- [GitHub](https://github.com/blueswen/mkdocs-swagger-ui-tag) (👨‍💻 6 · 🔀 10 · 📥 47 · 📦 290 · 📋 25 - 24% open · ⏱️ 04.05.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-coverage) (📥 41K / month):
	```
...
- [GitHub](https://github.com/pa-decarvalho/mkdocs-asciinema-player) (👨‍💻 4 · 🔀 1 · 📦 13 · 📋 31 - 12% open · ⏱️ 28.04.2025)
- [PyPi](https://pypi.org/project/mkdocs-asciinema-player) (📥 550 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mcp) (📥 32 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vercel-pw-plugin) (📥 34 / month):
	```
...
- [GitHub](https://github.com/ultrabug/mkdocs-static-i18n) (👨‍💻 13 · 🔀 42 · 📦 1.6K · 📋 150 - 16% open · ⏱️ 14.04.2025)
...
- [GitHub](https://github.com/mkdocs/mkdocs-redirects) (👨‍💻 18 · 🔀 28 · 📦 5.6K · 📋 40 - 30% open · ⏱️ 19.05.2025)
- [PyPi](https://pypi.org/project/mkdocs-redirects) (📥 730K / month):
	```
...
- [GitHub](https://github.com/shyamd/mkdocs-bibtex) (👨‍💻 18 · 🔀 27 · 📦 400 · 📋 57 - 15% open · ⏱️ 01.06.2025)
...
- [GitHub](https://github.com/manuzhang/mkdocs-htmlproofer-plugin) (👨‍💻 15 · 🔀 16 · 📦 500 · 📋 36 - 8% open · ⏱️ 23.09.2024)
...
- [GitHub](https://github.com/JakubAndrysek/mkdocs-open-in-new-tab) (👨‍💻 2 · 🔀 4 · 📦 530 · 📋 8 - 37% open · ⏱️ 18.11.2024)
- [PyPi](https://pypi.org/project/mkdocs-open-in-new-tab) (📥 73K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ezlinks-plugin) (📥 8.6K / month):
	```
...
- [GitHub](https://github.com/wilhelmer/mkdocs-unused-files) (👨‍💻 2 · 🔀 4 · 📦 30 · 📋 12 - 33% open · ⏱️ 17.07.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-webcontext-plugin) (📥 660 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-issues-plugin) (📥 40 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-backlinks-section-plugin) (📥 630 / month):
	```
...
- [GitHub](https://github.com/facelessuser/pymdown-extensions) (👨‍💻 52 · 🔀 260 · 📦 48K · 📋 400 - 2% open · ⏱️ 29.05.2025)
- [PyPi](https://pypi.org/project/pymdown-extensions) (📥 9.4M / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-callouts) (📥 87K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-truly-sane-lists) (📥 820K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-iconfonts) (📥 39 / month):
	```
...
- [PyPi](https://pypi.org/project/kbdextension) (📥 4.8K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-grid-tables) (📥 12K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-tweetable) (📥 6 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-sub-sup) (📥 47 / month):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-nav) (👨‍💻 10 · 🔀 39 · 📦 170 · 📋 100 - 18% open · ⏱️ 18.05.2025)
- [PyPi](https://pypi.org/project/mkdocs-awesome-nav) (📥 82K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-encryptcontent-plugin) (📥 6.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gallery) (📥 9.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-live-edit-plugin) (📥 670 / month):
	```
...
- [PyPi](https://pypi.org/project/mkrefs) (📥 26 / month):
	```
	pip install mkrefs
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-vim-md-tags-plugin) (📥 64 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-navsorted-plugin) (📥 940 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-title-casing-plugin) (📥 480 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-with-pdf) (📥 88K / month):
	```
...
- [GitHub](https://github.com/adrienbrignon/mkdocs-exporter) (👨‍💻 4 · 🔀 10 · 📦 34 · 📋 64 - 53% open · ⏱️ 29.10.2024)
- [PyPi](https://pypi.org/project/mkdocs-exporter) (📥 7.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-zip-folders) (📥 400 / month):
	```
...
<details><summary><b><a href="https://github.com/backstage/mkdocs-techdocs-core">techdocs-core</a></b>  - 🥇23 ·  ⭐ 99 · <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>The core MkDocs plugin used by Backstages TechDocs as a wrapper around multiple MkDocs plugins and Python Markdown..</summary>

- [GitHub](https://github.com/backstage/mkdocs-techdocs-core) (👨‍💻 46 · 🔀 68 · 📦 180 · 📋 72 - 1% open · ⏱️ 14.05.2025)
- [PyPi](https://pypi.org/project/mkdocs-techdocs-core) (📥 500K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-merge) (📥 4.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-same-dir) (📥 44K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-unused-files) (📥 3.1K / month):
	```
...
- [GitHub](https://github.com/rdilweb/mkdocs-plugin-progress) (👨‍💻 3 · 📦 40 · ⏱️ 20.06.2020)
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
   ```yaml
   plugins:
     - progress
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-tagged-files) (📥 73 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multiple) (📥 200 / month):
	```
...
- [GitHub](https://github.com/mondeja/mkdocs-include-markdown-plugin) (👨‍💻 17 · 🔀 23 · 📥 620 · 📦 3K · 📋 89 - 1% open · ⏱️ 07.03.2025)
...
- [PyPi](https://pypi.org/project/markdown-version-annotations) (📥 11K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gitsnippet-plugin) (📥 690 / month):
	```
