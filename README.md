...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 230 · 🔀 3K · 📦 37K · 📋 2K - 1% open · ⏱️ 30.09.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-gitbook) (📥 6.7K / month):
	```
...
- [GitHub](https://github.com/WSOFT-Project/lantana) (👨‍💻 3 · 📥 160 · 📦 1 · 📋 19 - 15% open · ⏱️ 26.08.2023)
- [PyPi](https://pypi.org/project/lantana) (📥 490 / month):
	```
	pip install lantana
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
...
- [PyPi](https://pypi.org/project/mkdocs-jinks) (📥 22 / month):
	```
...
- [GitHub](https://github.com/cryocaustik/mkdocs-semantic) (👨‍💻 6 · 🔀 3 · 📦 5 · 📋 8 - 12% open · ⏱️ 30.03.2021)
- [PyPi](https://pypi.org/project/mkdocs-semantic) (📥 28 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-bootstrap4) (📥 83 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-zettelkasten) (📥 35 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-unidata) (📥 43 / month):
	```
...
- [GitHub](https://github.com/hfagerlund/mkdocs-docskimmer) (📋 11 - 9% open · ⏱️ 11.10.2018)
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
   ```yaml
   theme: docskimmer
   ```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-topdf) (📥 28 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-moonstone) (📥 65 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github) (📥 61 / month):
	```
...
- [GitHub](https://github.com/Neoteroi/mkdocs-plugins) (👨‍💻 7 · 🔀 6 · 📥 460 · 📦 44 · 📋 26 - 34% open · ⏱️ 28.07.2023)
...
- [PyPi](https://pypi.org/project/mkautodoc) (📥 7.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-newsletter) (📥 650 / month):
	```
...
- [PyPi](https://pypi.org/project/mkblog) (📥 44 / month):
	```
	pip install mkblog
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/fralau/mkdocs-mermaid2-plugin) (👨‍💻 13 · 🔀 22 · 📦 1.5K · 📋 61 - 4% open · ⏱️ 26.09.2023)
...
- [GitHub](https://github.com/timvink/mkdocs-table-reader-plugin) (👨‍💻 6 · 🔀 12 · 📦 370 · 📋 37 - 8% open · ⏱️ 09.09.2023)
- [PyPi](https://pypi.org/project/mkdocs-table-reader-plugin) (📥 49K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-video) (📥 38K / month):
	```
...
- [GitHub](https://github.com/AVATEAM-IT-SYSTEMHAUS/mkdocs-kroki-plugin) (👨‍💻 11 · 🔀 21 · 📦 25 · 📋 19 - 42% open · ⏱️ 31.03.2023)
...
- [GitHub](https://github.com/quantorconsulting/mkdocs_build_plantuml) (👨‍💻 7 · 🔀 12 · 📦 90 · 📋 18 - 22% open · ⏱️ 04.12.2022)
...
- [GitHub](https://github.com/zoni/mkdocs-diagrams) (🔀 1 · 📦 50 · 📋 2 - 50% open · ⏱️ 04.09.2020)
- [PyPi](https://pypi.org/project/mkdocs-diagrams) (📥 4.5K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-figcap) (📥 90 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-jupyter) (📥 83K / month):
	```
...
- [GitHub](https://github.com/mkdocs-plugins/termynal) (👨‍💻 4 · 🔀 7 · 📦 88 · 📋 10 - 50% open · ⏱️ 21.08.2023)
...
- [GitHub](https://github.com/pawamoy/markdown-exec) (👨‍💻 2 · 🔀 4 · 📦 85 · 📋 23 - 39% open · ⏱️ 14.06.2023)
- [PyPi](https://pypi.org/project/markdown-exec) (📥 9.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-entangled-plugin) (📥 210 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdown-filter) (📥 360 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nbconvert) (📥 29 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs_protobuf) (📥 210 / month):
	```
...
- [GitHub](https://github.com/ojacques/mkdocs-git-committers-plugin-2) (👨‍💻 7 · 🔀 11 · 📦 270 · 📋 20 - 45% open · ⏱️ 06.09.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-git-committers-plugin) (📥 4.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-gh-links) (📥 4.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-enumerate-headings-plugin) (📥 7.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-safe-text-plugin) (📥 210 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-add-number-plugin) (📥 800 / month):
	```
...
- [GitHub](https://github.com/ultrabug/mkdocs-static-i18n) (👨‍💻 8 · 🔀 28 · 📦 730 · 📋 110 - 9% open · ⏱️ 21.09.2023)
- [PyPi](https://pypi.org/project/mkdocs-static-i18n) (📥 27K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autorefs) (📥 580K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-htmlproofer-plugin) (📥 28K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-tooltipster-links-plugin) (📥 280 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-site-urls) (📥 4.4K / month):
	```
...
- [PyPi](https://pypi.org/project/autolink-references-mkdocs-plugin) (📥 5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-marker) (📥 550 / month):
	```
...
- [GitHub](https://github.com/realtimeprojects/mkdocs-ezglossary) (📋 2 - 50% open · ⏱️ 29.09.2023)
- [PyPi](https://pypi.org/project/mkdocs-ezglossary-plugin) (📥 1.8K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-callouts) (📥 8.9K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-full-yaml-metadata) (📥 630 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-callouts) (📥 6K / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSubscript) (📥 280 / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSuperscript) (📥 8K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-breakless-lists) (📥 3.8K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-iconfonts) (📥 51 / month):
	```
...
- [PyPi](https://pypi.org/project/asciimathml) (📥 31 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 4.2K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown_sub_sup) (📥 55 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx_semanticdata) (📥 9 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx_semanticwikilinks) (📥 11 / month):
	```
...
- [GitHub](https://github.com/unverbuggt/mkdocs-encryptcontent-plugin) (👨‍💻 4 · 🔀 12 · 📥 79 · 📦 730 · 📋 46 - 2% open · ⏱️ 19.09.2023)
- [PyPi](https://pypi.org/project/mkdocs-encryptcontent-plugin) (📥 6.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude) (📥 99K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swangallery) (📥 18 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-weight) (📥 1.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-enhancements) (📥 3.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-schema-reader) (📥 450 / month):
	```
...
- [PyPi](https://pypi.org/project/mktestdocs) (📥 8.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-spellcheck) (📥 6.1K / month):
	```
...
- [GitHub](https://github.com/wilhelmer/mkdocs-localsearch) (👨‍💻 4 · 🔀 7 · 📦 62 · ⏱️ 02.01.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-pdf-with-js-plugin) (📥 550 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mk2pdf-plugin) (📥 86 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autozip) (📥 280 / month):
	```
...
- [GitHub](https://github.com/jdoiro3/mkdocs-multirepo-plugin) (👨‍💻 12 · 🔀 30 · 📦 87 · 📋 77 - 42% open · ⏱️ 07.09.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-merge) (📥 840 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multirepo) (📥 96 / month):
	```
...
- [GitHub](https://github.com/mondeja/mkdocs-include-markdown-plugin) (👨‍💻 13 · 🔀 15 · 📥 190 · 📦 1.6K · 📋 62 - 3% open · ⏱️ 31.08.2023)
...
- [GitHub](https://github.com/prcr/mkdocs-meta-descriptions-plugin) (👨‍💻 3 · 🔀 3 · 📦 710 · 📋 11 - 9% open · ⏱️ 12.09.2023)
- [PyPi](https://pypi.org/project/mkdocs-meta-descriptions-plugin) (📥 6.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-version-annotations) (📥 7.2K / month):
	```
...
- [GitHub](https://github.com/backstage/mkdocs-techdocs-core) (👨‍💻 34 · 🔀 48 · 📦 40 · 📋 46 - 10% open · ⏱️ 08.09.2023)
...
- [GitHub](https://github.com/shyamd/mkdocs-bibtex) (👨‍💻 10 · 🔀 14 · 📦 190 · 📋 35 - 22% open · ⏱️ 01.09.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-placeholder-plugin) (📥 490 / month):
	```
