...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 320 · 🔀 3.8K · 📦 74K · 📋 2.6K - 0% open · ⏱️ 18.10.2025)
...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (🔀 6 · 📥 100 · 📦 16 · 📋 18 - 5% open · ⏱️ 20.10.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-dracula-theme) (📥 4.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-kpn) (📥 660 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-custommill) (📥 530 / month):
	```
...
- [GitHub](https://github.com/TEParsons/mkdocs-landing) (👨‍💻 4 · 🔀 1 · 📥 4 · 📦 6 · ⏱️ 16.02.2025)
- [PyPi](https://pypi.org/project/mkdocs-landing) (📥 100 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alabaster) (📥 550 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap386) (📥 760 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 4.5M / month):
	```
...
- [GitHub](https://github.com/JakubAndrysek/MkDoxy) (👨‍💻 18 · 🔀 27 · 📦 50 · 📋 69 - 27% open · ⏱️ 29.08.2025)
...
- [GitHub](https://github.com/mkdocs/mkdocs-click) (👨‍💻 16 · 🔀 20 · 📦 960 · 📋 35 - 54% open · ⏱️ 18.06.2025)
- [PyPi](https://pypi.org/project/mkdocs-click) (📥 790K / month):
	```
...
- [PyPi](https://pypi.org/project/mkapi) (📥 8K / month):
	```
	pip install mkapi
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/tlambert03/mkdocs-api-autonav) (👨‍💻 2 · 🔀 1 · 📥 49 · 📦 90 · 📋 15 - 20% open · ⏱️ 27.09.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-typer2) (📥 7K / month):
	```
...
<details><summary><b><a href="https://github.com/watermarkhu/mkdocstrings-matlab">mkdocstrings-matlab</a></b>  - 🥉12 ·  ⭐ 9 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code><br>A MATLAB handler for mkdocstrings, automatic documentation from sources.</summary>

- [GitHub](https://github.com/watermarkhu/mkdocstrings-matlab) (👨‍💻 5 · 🔀 1 · 📦 2 · 📋 6 - 33% open · ⏱️ 08.10.2025)
- [PyPi](https://pypi.org/project/mkdocstrings-matlab) (📥 1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-azure-pipelines) (📥 42 / month):
	```
...
- [PyPi](https://pypi.org/project/automacdoc) (📥 31 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-apidescribed-plugin) (📥 1.4K / month):
	```
...
- [PyPi](https://pypi.org/project/ansible-mkdocs) (📥 56 / month):
	```
...
- [GitHub](https://github.com/Guts/mkdocs-rss-plugin) (👨‍💻 20 · 🔀 29 · 📥 350 · 📦 1.3K · 📋 59 - 25% open · ⏱️ 20.10.2025)
...
- [GitHub](https://github.com/mkdocs-publisher/mkdocs-publisher) (👨‍💻 3 · 🔀 8 · 📥 120 · 📦 93 · 📋 31 - 25% open · ⏱️ 11.07.2025)
- [PyPi](https://pypi.org/project/mkdocs-publisher) (📥 3.2K / month):
	```
...
- [GitHub](https://github.com/blueswen/mkdocs-glightbox) (👨‍💻 8 · 🔀 20 · 📥 44 · 📦 5.2K · 📋 54 - 40% open · ⏱️ 23.10.2025)
...
- [GitHub](https://github.com/fralau/mkdocs-mermaid2-plugin) (👨‍💻 16 · 🔀 28 · 📦 3.2K · 📋 84 - 15% open · ⏱️ 17.10.2025)
- [PyPi](https://pypi.org/project/mkdocs-mermaid2-plugin) (📥 650K / month):
	```
...
- [GitHub](https://github.com/AVATEAM-IT-SYSTEMHAUS/mkdocs-kroki-plugin) (👨‍💻 16 · 🔀 29 · 📦 69 · 📋 42 - 19% open · ⏱️ 28.07.2024)
...
- [PyPi](https://pypi.org/project/mkdocs-drawio-exporter) (📥 18K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-d2-plugin) (📥 20K / month):
	```
...
- [PyPi](https://pypi.org/project/oEmbedPy) (📥 6.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-resize-images) (📥 750 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bpmn-js) (📥 520 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-thumbnails) (📥 67 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-image-formatter-plugin) (📥 9 / month):
	```
...
- [GitHub](https://github.com/fralau/mkdocs-macros-plugin) (👨‍💻 35 · 🔀 48 · 📦 5.8K · 📋 140 - 0% open · ⏱️ 18.10.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-jupyter) (📥 310K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-exec) (📥 750K / month):
	```
...
- [GitHub](https://github.com/oprypin/mkdocs-gen-files) (👨‍💻 5 · 🔀 12 · 📦 3.4K · 📋 29 - 31% open · ⏱️ 15.02.2025)
- [PyPi](https://pypi.org/project/mkdocs-gen-files) (📥 650K / month):
	```
...
- [GitHub](https://github.com/markmap/mkdocs_markmap) (👨‍💻 3 · 🔀 6 · 📥 460 · 📋 34 - 11% open · ⏱️ 11.02.2025)
...
- [PyPi](https://pypi.org/project/termynal) (📥 38K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-entangled-plugin) (📥 3.7K / month):
	```
...
- [PyPi](https://pypi.org/project/pheasant) (📥 710 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nbconvert) (📥 760 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdown-filter) (📥 3.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-data-plugin) (📥 250 / month):
	```
...
<details><summary><b><a href="https://github.com/timvink/mkdocs-git-revision-date-localized-plugin">git-revision-date-localized</a></b>  - 🥇27 ·  ⭐ 260 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin to add a last updated date to your site pages.</summary>

- [GitHub](https://github.com/timvink/mkdocs-git-revision-date-localized-plugin) (👨‍💻 38 · 🔀 56 · 📦 11K · 📋 110 - 5% open · ⏱️ 09.09.2025)
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 📦 72 · ⏱️ 23.10.2025)
- [PyPi](https://pypi.org/project/mkdocs-minify-html-plugin) (📥 36K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-embeds-plugin) (📥 410 / month):
	```
...
<details><summary><b><a href="https://github.com/pawamoy/mkdocs-llmstxt">mkdocs-llmstxt</a></b>  - 🥇20 ·  ⭐ 80 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin to generate an /llms.txt file (https://llmstxt.org/).</summary>

- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 4 · 🔀 9 · 📦 85 · 📋 19 - 31% open · ⏱️ 03.10.2025)
- [PyPi](https://pypi.org/project/mkdocs-llmstxt) (📥 74K / month):
	```
...
- [PyPi](https://pypi.org/project/foliantcontrib.mkdocs) (📥 430 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-copy-to-llm) (📥 100 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vercel-pw-plugin) (📥 29 / month):
	```
...
- [GitHub](https://github.com/mkdocstrings/autorefs) (👨‍💻 9 · 🔀 11 · 📋 35 - 8% open · ⏱️ 26.08.2025)
- [PyPi](https://pypi.org/project/mkdocs-autorefs) (📥 4.3M / month):
	```
...
- [GitHub](https://github.com/manuzhang/mkdocs-htmlproofer-plugin) (👨‍💻 15 · 🔀 16 · 📦 570 · 📋 37 - 10% open · ⏱️ 23.09.2024)
- [PyPi](https://pypi.org/project/mkdocs-htmlproofer-plugin) (📥 70K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-open-in-new-tab) (📥 260K / month):
	```
...
- [GitHub](https://github.com/OctoPrint/mkdocs-site-urls) (👨‍💻 2 · 🔀 3 · 📦 59 · 📋 5 - 40% open · ⏱️ 04.09.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-unused-files) (📥 6.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-tooltipster-links-plugin) (📥 39 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-issues-plugin) (📥 62 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-addresses) (📥 95 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-iconfonts) (📥 95 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-emdash) (📥 99 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-del-ins) (📥 1.9K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-sub-sup) (📥 320 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticwikilinks) (📥 65 / month):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-nav) (👨‍💻 10 · 🔀 40 · 📦 320 · 📋 120 - 19% open · ⏱️ 10.09.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-simple-hooks) (📥 87K / month):
	```
...
- [GitHub](https://github.com/tombreit/mkdocs-pagetree-plugin) (👨‍💻 3 · 🔀 3 · 📦 21 · 📋 14 - 28% open · ⏱️ 16.03.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-categories-plugin) (📥 1.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-breadcrumbs-plugin) (📥 3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toc-sidebar-plugin) (📥 420 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-enhancements) (📥 6.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-schema-reader) (📥 4.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-spellcheck) (📥 32K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codecheck) (📥 54 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-localsearch) (📥 6.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-search) (📥 53K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-task-collector) (📥 290 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exporter) (📥 16K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-zip-folders) (📥 110 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autozip) (📥 51 / month):
	```
...
- [PyPi](https://pypi.org/project/mike) (📥 740K / month):
	```
	pip install mike
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-techdocs-core) (📥 1.3M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-monorepo-plugin) (📥 2.1M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-versioning) (📥 5.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-unused-files) (📥 7.2K / month):
	```
...
- [GitHub](https://github.com/virtualguard101/mkdocs-note) (👨‍💻 2 · 🔀 1 · 📋 17 - 17% open · ⏱️ 20.10.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-required-frontmatter-plugin) (📥 180 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-new-features-notifier) (📥 200 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeinclude-plugin) (📥 9.1K / month):
	```
