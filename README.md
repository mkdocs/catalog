...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 320 · 🔀 3.8K · 📦 73K · 📋 2.6K - 0% open · ⏱️ 28.08.2025)
...
- [GitHub](https://github.com/chrissimpkins/cinder) (👨‍💻 23 · 🔀 98 · 📥 1K · 📦 680 · 📋 51 - 31% open · ⏱️ 05.01.2021)
...
- [PyPi](https://pypi.org/project/mkdocs-dracula-theme) (📥 3.8K / month):
	```
...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (🔀 3 · 📥 51 · 📦 10 · 📋 11 - 27% open · ⏱️ 26.08.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-terminal) (📥 4.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-windmill) (📥 5.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-curriculum-vitae) (📥 68 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-kpn) (📥 470 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swan) (📥 79 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-moonstone) (📥 990 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-python) (📥 7.9M / month):
	```
...
- [GitHub](https://github.com/Neoteroi/mkdocs-plugins) (👨‍💻 12 · 🔀 11 · 📥 12K · 📦 430 · 📋 44 - 43% open · ⏱️ 02.08.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-click) (📥 600K / month):
	```
...
- [PyPi](https://pypi.org/project/mkapi) (📥 5K / month):
	```
	pip install mkapi
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/tlambert03/mkdocs-api-autonav) (👨‍💻 2 · 🔀 1 · 📥 43 · 📦 63 · 📋 12 - 8% open · ⏱️ 18.08.2025)
- [PyPi](https://pypi.org/project/mkdocs-api-autonav) (📥 67K / month):
	```
...
<details><summary><b><a href="https://github.com/syn54x/mkdocs-typer2">mkdocs-typer2</a></b>  - 🥈13 ·  ⭐ 11 · <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Mkdocs Plugin For Typer CLI Docs.</summary>

- [GitHub](https://github.com/syn54x/mkdocs-typer2) (📦 9 · 📋 7 - 28% open · ⏱️ 11.07.2025)
- [PyPi](https://pypi.org/project/mkdocs-typer2) (📥 5.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkautodoc) (📥 32K / month):
	```
...
- [GitHub](https://github.com/watermarkhu/mkdocstrings-matlab) (👨‍💻 4 · 🔀 1 · 📦 2 · 📋 6 - 33% open · ⏱️ 26.08.2025)
- [PyPi](https://pypi.org/project/mkdocstrings-matlab) (📥 660 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-vba) (📥 470 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-azure-pipelines) (📥 33 / month):
	```
...
- [PyPi](https://pypi.org/project/automacdoc) (📥 25 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pipeline-visualizer) (📥 67 / month):
	```
...
- [PyPi](https://pypi.org/project/inari) (📥 46 / month):
	```
	pip install inari
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-apidescribed-plugin) (📥 26 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-rss-plugin) (📥 99K / month):
	```
...
- [PyPi](https://pypi.org/project/mkblog) (📥 30 / month):
	```
	pip install mkblog
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/fralau/mkdocs-mermaid2-plugin) (👨‍💻 16 · 🔀 28 · 📦 3.1K · 📋 80 - 15% open · ⏱️ 27.08.2025)
- [PyPi](https://pypi.org/project/mkdocs-mermaid2-plugin) (📥 500K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-kroki-plugin) (📥 130K / month):
	```
...
<details><summary><b><a href="https://github.com/PLAYG0N/mkdocs-panzoom">panzoom</a></b>  - 🥈21 ·  ⭐ 48 · 📈 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs Plugin to enable pan & zoom on images and mermaid/d2 diagrams.</summary>

- [GitHub](https://github.com/PLAYG0N/mkdocs-panzoom) (👨‍💻 7 · 🔀 2 · 📥 35 · 📦 26 · 📋 27 - 18% open · ⏱️ 28.08.2025)
- [PyPi](https://pypi.org/project/mkdocs-panzoom-plugin) (📥 530K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-puml) (📥 41K / month):
	```
...
- [PyPi](https://pypi.org/project/oEmbedPy) (📥 3.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-obsidian-interactive-graph-plugin) (📥 690 / month):
	```
...
- [PyPi](https://pypi.org/project/docutools) (📥 950 / month):
	```
...
- [PyPi](https://pypi.org/project/Termage) (📥 22 / month):
	```
	pip install Termage
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-badges) (📥 5.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-resize-images) (📥 390 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-wavedrom-plugin) (📥 96 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-svgbob) (📥 720 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-thumbnails) (📥 49 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-inline-svg-mod) (📥 260 / month):
	```
...
- [PyPi](https://pypi.org/project/pico8-mkdocs-plugin) (📥 11 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-exec) (📥 540K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gen-files) (📥 700K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdownextradata-plugin) (📥 91K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 500K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdown-filter) (📥 2.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-entangled-plugin) (📥 4.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkjsfiddle) (📥 57 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-data-plugin) (📥 54 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-protobuf) (📥 1.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-authors-plugin) (📥 180K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-committers-plugin-2) (📥 100K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github-changelog) (📥 360 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-latest-release-plugin) (📥 850 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-enumerate-headings-plugin) (📥 38K / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 📦 72 · ⏱️ 28.08.2025)
- [PyPi](https://pypi.org/project/mkdocs-minify-html-plugin) (📥 37K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-embeds-plugin) (📥 480 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toggle-sidebar-plugin) (📥 9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ai-summary) (📥 57 / month):
	```
...
- [PyPi](https://pypi.org/project/mk-append-to-head) (📥 110 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swagger-ui-tag) (📥 86K / month):
	```
...
<details><summary><b><a href="https://github.com/pawamoy/mkdocs-llmstxt">mkdocs-llmstxt</a></b>  - 🥇19 ·  ⭐ 66 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin to generate an /llms.txt file (https://llmstxt.org/).</summary>

- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 3 · 🔀 6 · 📦 56 · 📋 19 - 31% open · ⏱️ 07.08.2025)
- [PyPi](https://pypi.org/project/mkdocs-llmstxt) (📥 53K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-coverage) (📥 53K / month):
	```
...
<details><summary><b><a href="https://github.com/ubaumann/mkdocs-mcp">mkdocs-mcp</a></b>  - 🥉7 ·  ⭐ 2 · 🐣 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs Plugin to serve MCP.</summary>

- [GitHub](https://github.com/ubaumann/mkdocs-mcp) (⏱️ 11.08.2025)
- [PyPi](https://pypi.org/project/mkdocs-mcp) (📥 30 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-licenseinfo) (📥 39 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vercel-pw-plugin) (📥 33 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-htmlproofer-plugin) (📥 59K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-marker) (📥 510K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alias-plugin) (📥 2.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-unused-files) (📥 4.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ezglossary-plugin) (📥 6.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-webcontext-plugin) (📥 500 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-tooltipster-links-plugin) (📥 37 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-argref-plugin) (📥 1.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-issues-plugin) (📥 42 / month):
	```
...
- [PyPi](https://pypi.org/project/python-markdown-math) (📥 210K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-callouts) (📥 95K / month):
	```
...
- [PyPi](https://pypi.org/project/asciimathml) (📥 600 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 9.8K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-emdash) (📥 77 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-grid-tables) (📥 25K / month):
	```
	pip install markdown-grid-tables
	```
- [GitLab](https://gitlab.com/WillDaSilva/markdown_grid_tables) (🔀 7 · ⏱️ 09.02.2022)
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#markdown_extensions):
   ```yaml
   markdown_extensions:
...
- [PyPi](https://pypi.org/project/markdown-sub-sup) (📥 84 / month):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-nav) (👨‍💻 10 · 🔀 40 · 📦 260 · 📋 110 - 19% open · ⏱️ 18.05.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-encryptcontent-plugin) (📥 7.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude) (📥 320K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gallery) (📥 40K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vim-md-tags-plugin) (📥 37 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-remove-sections-plugin) (📥 26 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-navsorted-plugin) (📥 20 / month):
	```
...
- [GitHub](https://github.com/pawamoy/mkdocs-spellcheck) (👨‍💻 4 · 🔀 4 · 📦 75 · 📋 26 - 34% open · ⏱️ 05.08.2025)
- [PyPi](https://pypi.org/project/mkdocs-spellcheck) (📥 28K / month):
	```
...
- [PyPi](https://pypi.org/project/mktestdocs) (📥 39K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-search) (📥 38K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-task-collector) (📥 200 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-print-site-plugin) (📥 98K / month):
	```
...
- [PyPi](https://pypi.org/project/mkpdfs-mkdocs) (📥 580 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-zip-folders) (📥 130 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autozip) (📥 52 / month):
	```
...
- [GitHub](https://github.com/jimporter/mike) (👨‍💻 9 · 🔀 49 · 📥 420 · 📦 4.7K · 📋 200 - 6% open · ⏱️ 16.03.2025)
- [PyPi](https://pypi.org/project/mike) (📥 670K / month):
	```
	pip install mike
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-techdocs-core) (📥 940K / month):
	```
...
- [GitHub](https://github.com/ldeluigi/markdown-docs) (👨‍💻 6 · 🔀 6 · 📦 110 · ⏱️ 25.08.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-versioning) (📥 6.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-unused-files) (📥 6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-same-dir) (📥 48K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yamp) (📥 67 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-auto-refresh-build-pages) (📥 1.4K / month):
	```
...
- [GitHub](https://github.com/leonardehrenfried/mkdocs-no-sitemap-plugin) (👨‍💻 2 · 🔀 1 · 📦 42 · ⏱️ 23.08.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-required-frontmatter-plugin) (📥 10 / month):
	```
...
- [GitHub](https://github.com/mondeja/mkdocs-include-markdown-plugin) (👨‍💻 17 · 🔀 25 · 📥 660 · 📦 3.1K · 📋 91 - 1% open · ⏱️ 27.08.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-meta-descriptions-plugin) (📥 9.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeinclude-plugin) (📥 7.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-snippet-plugin) (📥 2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gitsnippet-plugin) (📥 870 / month):
	```
