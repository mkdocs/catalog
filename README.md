...
- [PyPi](https://pypi.org/project/mkdocs-curriculum-vitae) (📥 730 / month):
	```
...
- [GitHub](https://github.com/TEParsons/torillic) (👨‍💻 4 · 🔀 89 · 📥 7.9K · 📋 12 - 8% open · ⏱️ 05.09.2024)
- [PyPi](https://pypi.org/project/mkdocs-torillic) (📥 1.4K / month):
	```
...
<details><summary><b><a href="https://github.com/wsoft-ws/lantana">Lantana</a></b>  - 🥈13 ·  ⭐ 18 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1495/PNG/32/preferencesdesktoptheme_102980.png" style="display:inline;" width="13" height="13"></code><br>Lantana MKDocsHTML.</summary>
...
- [PyPi](https://pypi.org/project/lantana) (📥 1.7K / month):
	```
	pip install lantana
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
...
- [PyPi](https://pypi.org/project/mkdocs-zettelkasten) (📥 480 / month):
	```
...
- [GitHub](https://github.com/daizutabi/mkdocs-ivory) (👨‍💻 2 · 🔀 4 · 📦 96 · 📋 6 - 50% open · ⏱️ 16.06.2020)
...
- [PyPi](https://pypi.org/project/mkdocs-custommill) (📥 770 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alabaster) (📥 490 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-windmill-dark) (📥 960 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap386) (📥 920 / month):
	```
...
<details><summary><b><a href="https://github.com/daizutabi/mkapi">MkApi</a></b>  - 🥇23 ·  ⭐ 110 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>A powerful MkDocs plugin for automatic API documentation generation from Python docstrings.</summary>

- [GitHub](https://github.com/daizutabi/mkapi) (👨‍💻 5 · 🔀 17 · 📦 210 · 📋 140 - 2% open · ⏱️ 12.04.2025)
- [PyPi](https://pypi.org/project/mkapi) (📥 8.4K / month):
	```
	pip install mkapi
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-click) (📥 630K / month):
	```
...
- [GitHub](https://github.com/Neoteroi/mkdocs-plugins) (👨‍💻 10 · 🔀 7 · 📥 6.9K · 📦 380 · 📋 43 - 44% open · ⏱️ 04.09.2024)
...
- [PyPi](https://pypi.org/project/mkdocs-autoapi) (📥 6.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-api-autonav) (📥 8.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mktheapidocs) (📥 900 / month):
	```
...
- [PyPi](https://pypi.org/project/automacdoc) (📥 140 / month):
	```
...
- [GitHub](https://github.com/fmaida/mkdocs-blog-plugin) (🔀 4 · 📦 150 · 📋 2 - 50% open · ⏱️ 13.04.2020)
...
- [PyPi](https://pypi.org/project/plantuml-markdown) (📥 480K / month):
	```
...
- [GitHub](https://github.com/blueswen/mkdocs-glightbox) (👨‍💻 7 · 🔀 19 · 📥 40 · 📦 4.3K · 📋 50 - 46% open · ⏱️ 16.10.2024)
- [PyPi](https://pypi.org/project/mkdocs-glightbox) (📥 510K / month):
	```
...
<details><summary><b><a href="https://github.com/PLAYG0N/mkdocs-panzoom">panzoom</a></b>  - 🥈20 ·  ⭐ 30 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs Plugin to enable pan & zoom on images and mermaid/d2 diagrams.</summary>

- [GitHub](https://github.com/PLAYG0N/mkdocs-panzoom) (👨‍💻 4 · 🔀 1 · 📥 34 · 📦 15 · 📋 17 - 17% open · ⏱️ 26.03.2025)
- [PyPi](https://pypi.org/project/mkdocs-panzoom-plugin) (📥 580K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-table-reader-plugin) (📥 95K / month):
	```
...
- [GitHub](https://github.com/soulless-viewer/mkdocs-video) (👨‍💻 5 · 🔀 13 · 📥 71 · 📦 970 · ⏱️ 04.01.2024)
...
- [PyPi](https://pypi.org/project/oEmbedPy) (📥 5.3K / month):
	```
...
<details><summary><b><a href="https://github.com/daxcore/mkdocs-obsidian-interactive-graph-plugin">Interactive Graph</a></b>  - 🥈14 ·  ⭐ 25 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>interactive graph for Material for MkDocs like Obsidian, refer demo:.</summary>

- [GitHub](https://github.com/daxcore/mkdocs-obsidian-interactive-graph-plugin) (👨‍💻 2 · 🔀 4 · 📦 43 · ⏱️ 14.12.2024)
...
- [GitHub](https://github.com/zoni/mkdocs-diagrams) (🔀 3 · 📦 73 · 📋 3 - 33% open · ⏱️ 04.09.2020)
...
- [PyPi](https://pypi.org/project/mkdocs-mermaid-plugin) (📥 7.3K / month):
	```
...
- [GitHub](https://github.com/six-two/mkdocs-badges) (🔀 1 · 📋 7 - 28% open · ⏱️ 11.04.2025)
...
- [PyPi](https://pypi.org/project/markdown-captions) (📥 4.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-resize-images) (📥 980 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-inline-svg-mod) (📥 820 / month):
	```
...
- [GitHub](https://github.com/pawamoy/markdown-exec) (👨‍💻 4 · 🔀 13 · 📦 490 · 📋 66 - 25% open · ⏱️ 24.03.2025)
- [PyPi](https://pypi.org/project/markdown-exec) (📥 310K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gen-files) (📥 660K / month):
	```
...
- [PyPi](https://pypi.org/project/pheasant) (📥 2.2K / month):
	```
...
- [GitHub](https://github.com/timvink/mkdocs-git-revision-date-localized-plugin) (👨‍💻 34 · 🔀 49 · 📦 9.5K · 📋 110 - 3% open · ⏱️ 21.03.2025)
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 📦 61 · ⏱️ 17.04.2025)
...
- [GitHub](https://github.com/orzih/mkdocs-extra-sass-plugin) (🔀 4 · 📦 60 · ⏱️ 13.02.2021)
...
- [PyPi](https://pypi.org/project/mkdocs-link-embeds-plugin) (📥 700 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ai-summary) (📥 330 / month):
	```
...
<details><summary><b><a href="https://github.com/pawamoy/mkdocs-llmstxt">mkdocs-llmstxt</a></b>  - 🥉11 ·  ⭐ 26 · 🐣 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin to generate an /llms.txt file (https://llmstxt.org/).</summary>

- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 2 · 🔀 1 · 📦 3 · 📋 6 - 66% open · ⏱️ 08.04.2025)
- [PyPi](https://pypi.org/project/mkdocs-llmstxt) (📥 6.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mdpo-plugin) (📥 740 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-redirects) (📥 690K / month):
	```
...
- [GitHub](https://github.com/shyamd/mkdocs-bibtex) (👨‍💻 18 · 🔀 25 · 📦 380 · 📋 53 - 9% open · ⏱️ 01.04.2025)
...
- [GitHub](https://github.com/JakubAndrysek/mkdocs-open-in-new-tab) (👨‍💻 2 · 🔀 4 · 📦 470 · 📋 7 - 28% open · ⏱️ 18.11.2024)
...
- [GitHub](https://github.com/OctoPrint/mkdocs-site-urls) (🔀 1 · 📦 44 · 📋 2 - 50% open · ⏱️ 07.01.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-tooltipster-links-plugin) (📥 87 / month):
	```
...
- [GitHub](https://github.com/facelessuser/pymdown-extensions) (👨‍💻 50 · 🔀 260 · 📦 45K · 📋 400 - 2% open · ⏱️ 28.03.2025)
...
- [PyPi](https://pypi.org/project/mdx-truly-sane-lists) (📥 750K / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSubscript) (📥 480 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-emdash) (📥 520 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-grid-tables) (📥 9.7K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-del-ins) (📥 840 / month):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-nav) (👨‍💻 9 · 🔀 36 · 📦 80 · 📋 100 - 18% open · ⏱️ 06.04.2025)
- [PyPi](https://pypi.org/project/mkdocs-awesome-nav) (📥 46K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-live-edit-plugin) (📥 790 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toc-sidebar-plugin) (📥 48K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-categories-plugin) (📥 550 / month):
	```
...
- [GitHub](https://github.com/mihaigalos/mkdocs-breadcrumbs-plugin) (👨‍💻 5 · 🔀 2 · 📦 6 · 📋 5 - 80% open · ⏱️ 26.02.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-pug) (📥 48 / month):
	```
...
<details><summary><b><a href="https://github.com/byrnereese/linkchecker-mkdocs">Link Checker</a></b>  - 🥈11 ·  ⭐ 12 · 💤 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code><br>Python asyncio + aiohttp Markdown *.md URL link checker: 10,000 files/second.</summary>

- [GitHub](https://github.com/byrnereese/linkchecker-mkdocs) (👨‍💻 5 · 🔀 5 · ⏱️ 24.08.2021)
- [PyPi](https://pypi.org/project/mkdocs-linkcheck) (📥 10K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-code-validator) (📥 620 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-print-site-plugin) (📥 54K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exporter) (📥 8.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mike) (📥 520K / month):
	```
	pip install mike
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/backstage/mkdocs-techdocs-core) (👨‍💻 46 · 🔀 66 · 📦 92 · 📋 72 - 2% open · ⏱️ 15.04.2025)
...
- [GitHub](https://github.com/ldeluigi/markdown-docs) (👨‍💻 4 · 🔀 5 · 📦 98 · ⏱️ 07.04.2025)
- [Docker Hub](https://hub.docker.com/r/deloo/markdown-docs) (📥 36K · ⏱️ 07.04.2025):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multirepo) (📥 470 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-unused-files) (📥 3.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-auto-refresh-build-pages) (📥 470 / month):
	```
...
- [GitHub](https://github.com/prcr/mkdocs-meta-descriptions-plugin) (👨‍💻 3 · 🔀 3 · 📦 1.2K · 📋 12 - 16% open · ⏱️ 13.04.2025)
...
- [GitHub](https://github.com/glennmatthews/markdown-version-annotations) (📥 26 · 📦 51 · ⏱️ 06.05.2024)
- [PyPi](https://pypi.org/project/markdown-version-annotations) (📥 8.8K / month):
	```
