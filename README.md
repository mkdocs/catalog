...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 330 · 🔀 3.9K · 📦 80K · 📋 2.7K - 0% open · ⏱️ 19.02.2026)
...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (👨‍💻 2 · 🔀 13 · 📥 130 · 📦 48 · 📋 22 - 9% open · ⏱️ 03.02.2026)
- [PyPi](https://pypi.org/project/mkdocs-shadcn) (📥 49K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-dracula-theme) (📥 5.6K / month):
	```
...
- [GitHub](https://github.com/buvis/mkdocs-zettelkasten) (👨‍💻 4 · 🔀 3 · 📥 46 · 📦 6 · 📋 36 - 11% open · ⏱️ 19.02.2026)
- [PyPi](https://pypi.org/project/mkdocs-zettelkasten) (📥 290 / month):
	```
...
- [PyPi](https://pypi.org/project/lantana) (📥 320 / month):
	```
	pip install lantana
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
...
- [PyPi](https://pypi.org/project/mkdocs-kpn) (📥 840 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-custommill) (📥 360 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-windmill-dark) (📥 830 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-moonstone) (📥 420 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-topdf) (📥 38 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-python) (📥 9.4M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-click) (📥 1M / month):
	```
...
- [PyPi](https://pypi.org/project/mkapi) (📥 9.8K / month):
	```
	pip install mkapi
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/JakubAndrysek/MkDoxy) (👨‍💻 18 · 🔀 33 · 📦 56 · 📋 71 - 29% open · ⏱️ 29.08.2025)
- [PyPi](https://pypi.org/project/mkdoxy) (📥 51K / month):
	```
	pip install mkdoxy
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-api-autonav) (📥 95K / month):
	```
...
- [GitHub](https://github.com/syn54x/mkdocs-typer2) (🔀 1 · 📦 24 · ⏱️ 15.01.2026)
...
<details><summary><b><a href="https://github.com/watermarkhu/mkdocstrings-matlab">mkdocstrings-matlab</a></b>  - 🥈14 ·  ⭐ 11 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code><br>A MATLAB handler for mkdocstrings, automatic documentation from sources.</summary>

- [GitHub](https://github.com/watermarkhu/mkdocstrings-matlab) (👨‍💻 5 · 🔀 1 · 📥 10 · 📦 2 · 📋 7 - 42% open · ⏱️ 15.02.2026)
- [PyPi](https://pypi.org/project/mkdocstrings-matlab) (📥 1.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-typedoc) (📥 410 / month):
	```
...
- [PyPi](https://pypi.org/project/ansible-mkdocs) (📥 64 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-blog-plugin) (📥 5.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkblog) (📥 24 / month):
	```
	pip install mkblog
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/plantuml-markdown) (📥 1.8M / month):
	```
...
- [GitHub](https://github.com/AVATEAM-IT-SYSTEMHAUS/mkdocs-kroki-plugin) (👨‍💻 19 · 🔀 29 · 📦 87 · 📋 45 - 2% open · ⏱️ 17.02.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-mermaid2-plugin) (📥 2M / month):
	```
...
- [GitHub](https://github.com/PLAYG0N/mkdocs-panzoom) (👨‍💻 7 · 🔀 2 · 📥 45 · 📦 46 · 📋 33 - 18% open · ⏱️ 22.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-panzoom-plugin) (📥 980K / month):
	```
...
- [GitHub](https://github.com/christo-ph/mkdocs_build_plantuml) (👨‍💻 13 · 🔀 17 · 📦 140 · 📋 26 - 19% open · ⏱️ 23.01.2026)
- [PyPi](https://pypi.org/project/mkdocs-build-plantuml-plugin) (📥 65K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-puml) (📥 84K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-video) (📥 150K / month):
	```
...
- [GitHub](https://github.com/landmaj/mkdocs-d2-plugin) (👨‍💻 3 · 🔀 7 · 📦 27 · 📋 20 - 10% open · ⏱️ 16.12.2024)
- [PyPi](https://pypi.org/project/mkdocs-d2-plugin) (📥 26K / month):
	```
...
- [PyPi](https://pypi.org/project/oEmbedPy) (📥 950 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-diagrams) (📥 74K / month):
	```
...
- [PyPi](https://pypi.org/project/Termage) (📥 81 / month):
	```
	pip install Termage
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/markdown-captions) (📥 12K / month):
	```
...
- [PyPi](https://pypi.org/project/docutools) (📥 780 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bpmn-js) (📥 2.9K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-svgbob) (📥 920 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-graphviz) (📥 9.6K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-figcap) (📥 49 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-aafigure) (📥 79 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-macros-plugin) (📥 2.9M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-jupyter) (📥 430K / month):
	```
...
- [GitHub](https://github.com/pawamoy/markdown-exec) (👨‍💻 6 · 🔀 16 · 📦 720 · 📋 67 - 22% open · ⏱️ 10.02.2026)
...
- [GitHub](https://github.com/greenape/mknotebooks) (👨‍💻 14 · 🔀 19 · 📦 770 · 📋 41 - 36% open · ⏱️ 11.08.2023)
...
- [PyPi](https://pypi.org/project/termynal) (📥 63K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-entangled-plugin) (📥 3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-jupyterlite) (📥 2.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdown-filter) (📥 4.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nbconvert) (📥 1.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkjsfiddle) (📥 44 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-protobuf) (📥 2.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-codeyaml-plugin) (📥 30 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-plugin) (📥 1.1M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-recently-updated-docs) (📥 310 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-branchcustomization-plugin) (📥 750 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-minify-plugin) (📥 850K / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 🔀 1 · 📦 95 · ⏱️ 18.02.2026)
...
<details><summary><b><a href="https://github.com/pawamoy/mkdocs-llmstxt">mkdocs-llmstxt</a></b>  - 🥇21 ·  ⭐ 100 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin to generate an /llms.txt file (https://llmstxt.org/).</summary>

- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 5 · 🔀 11 · 📦 250 · ⏱️ 01.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-llmstxt) (📥 190K / month):
	```
...
<details><summary><b><a href="https://github.com/leonardocustodio/mkdocs-copy-to-llm">mkdocs-copy-to-llm</a></b>  - 🥉12 ·  ⭐ 12 · 📈 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>A MkDocs plugin that adds a Copy to LLM button to your documentation, making it easy to copy code blocks and entire..</summary>

- [GitHub](https://github.com/leonardocustodio/mkdocs-copy-to-llm) (👨‍💻 3 · 🔀 3 · 📦 1 · 📋 7 - 28% open · ⏱️ 31.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-copy-to-llm) (📥 560 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mcp) (📥 70 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-licenseinfo) (📥 89 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-redirects) (📥 2M / month):
	```
...
- [GitHub](https://github.com/manuzhang/mkdocs-htmlproofer-plugin) (👨‍💻 15 · 🔀 17 · 📦 640 · 📋 38 - 7% open · ⏱️ 23.01.2026)
- [PyPi](https://pypi.org/project/mkdocs-htmlproofer-plugin) (📥 86K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autorefs) (📥 6.1M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autolinks-plugin) (📥 70K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-open-in-new-tab) (📥 310K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bibtex) (📥 59K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ezglossary-plugin) (📥 20K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-wikilink-plus) (📥 9.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-backlinks-section-plugin) (📥 2.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-issues-plugin) (📥 81 / month):
	```
...
- [GitHub](https://github.com/facelessuser/pymdown-extensions) (👨‍💻 56 · 🔀 270 · 📦 54K · 📋 420 - 3% open · ⏱️ 15.02.2026)
- [PyPi](https://pypi.org/project/pymdown-extensions) (📥 19M / month):
	```
...
- [PyPi](https://pypi.org/project/python-markdown-math) (📥 320K / month):
	```
...
- [GitHub](https://github.com/oprypin/markdown-callouts) (👨‍💻 2 · 🔀 14 · 📦 620 · 📋 13 - 38% open · ⏱️ 15.02.2025)
...
- [PyPi](https://pypi.org/project/mdx-truly-sane-lists) (📥 3.1M / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-breakless-lists) (📥 25K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 730K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-del-ins) (📥 4.4K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-sub-sup) (📥 340 / month):
	```
...
- [GitHub](https://github.com/pawamoy/markdown-pycon) (📦 7 · ⏱️ 10.01.2025)
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#markdown_extensions):
   ```yaml
   markdown_extensions:
     - pycon
...
- [PyPi](https://pypi.org/project/markdown-grid-tables) (📥 39K / month):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-nav) (👨‍💻 11 · 🔀 42 · 📦 450 · 📋 120 - 18% open · ⏱️ 02.12.2025)
...
- [PyPi](https://pypi.org/project/mkrefs) (📥 70 / month):
	```
	pip install mkrefs
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-navsorted-plugin) (📥 210 / month):
	```
...
- [GitHub](https://github.com/pawamoy/mkdocs-spellcheck) (👨‍💻 7 · 🔀 5 · 📦 85 · ⏱️ 11.02.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-code-validator) (📥 890 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-localsearch) (📥 5.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-search) (📥 54K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extract-listings-plugin) (📥 540 / month):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 75 · 📦 870 · 📋 120 - 57% open · ⏱️ 14.10.2021)
...
- [GitHub](https://github.com/timvink/mkdocs-print-site-plugin) (👨‍💻 16 · 🔀 29 · 📋 110 - 10% open · ⏱️ 30.10.2025)
...
- [GitHub](https://github.com/adrienbrignon/mkdocs-exporter) (👨‍💻 4 · 🔀 17 · 📦 47 · 📋 71 - 56% open · ⏱️ 29.10.2024)
...
- [GitHub](https://github.com/jimporter/mike) (👨‍💻 9 · 🔀 50 · 📥 430 · 📦 5.7K · 📋 200 - 7% open · ⏱️ 03.12.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-techdocs-core) (📥 1.7M / month):
	```
...
- [GitHub](https://github.com/backstage/mkdocs-monorepo-plugin) (👨‍💻 32 · 🔀 78 · 📦 620 · 📋 75 - 54% open · ⏱️ 15.06.2025)
- [PyPi](https://pypi.org/project/mkdocs-monorepo-plugin) (📥 2.7M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-simple-plugin) (📥 48K / month):
	```
...
- [Docker Hub](https://hub.docker.com/r/deloo/markdown-docs) (📥 45K · ⏱️ 01.02.2026):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-same-dir) (📥 81K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-auto-refresh-build-pages) (📥 340 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-note) (📥 340 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multiple) (📥 730 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-include-markdown-plugin) (📥 460K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-include) (📥 240K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-snippet-plugin) (📥 650 / month):
	```
