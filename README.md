...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 320 · 🔀 3.7K · 📦 70K · ⏱️ 10.06.2025)
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 7.3M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-terminal) (📥 6.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-zettelkasten) (📥 380 / month):
	```
...
- [PyPi](https://pypi.org/project/lantana) (📥 170 / month):
	```
	pip install lantana
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (🔀 2 · 📥 2 · 📦 4 · 📋 2 - 50% open · ⏱️ 21.05.2025)
- [PyPi](https://pypi.org/project/mkdocs-shadcn) (📥 410 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-bootstrap4) (📥 91 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-landing) (📥 89 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nature) (📥 720 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-risonia-theme) (📥 21 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-python) (📥 5.9M / month):
	```
...
- [GitHub](https://github.com/Neoteroi/mkdocs-plugins) (👨‍💻 10 · 🔀 8 · 📥 9.2K · 📦 410 · 📋 43 - 41% open · ⏱️ 22.04.2025)
...
- [PyPi](https://pypi.org/project/mkdoxy) (📥 27K / month):
	```
	pip install mkdoxy
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/mkdocstrings/crystal) (👨‍💻 3 · 🔀 3 · 📦 960 · 📋 6 - 66% open · ⏱️ 15.02.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-autoapi) (📥 6.7K / month):
	```
...
<details><summary><b><a href="https://github.com/tlambert03/mkdocs-api-autonav">mkdocs-api-autonav</a></b>  - 🥈13 ·  ⭐ 18 · 🐣 · <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin for autogenerating API docs with navigation.</summary>

- [GitHub](https://github.com/tlambert03/mkdocs-api-autonav) (👨‍💻 2 · 🔀 1 · 📥 40 · 📦 27 · 📋 10 - 10% open · ⏱️ 18.05.2025)
- [PyPi](https://pypi.org/project/mkdocs-api-autonav) (📥 30K / month):
	```
...
- [PyPi](https://pypi.org/project/mktheapidocs) (📥 990 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-typer2) (📥 1.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-material-adr) (📥 990 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-azure-pipelines) (📥 35 / month):
	```
...
- [PyPi](https://pypi.org/project/inari) (📥 70 / month):
	```
	pip install inari
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [GitHub](https://github.com/mkdocs-publisher/mkdocs-publisher) (👨‍💻 3 · 🔀 7 · 📥 82 · 📦 87 · 📋 29 - 24% open · ⏱️ 09.04.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-newsletter) (📥 570 / month):
	```
...
- [PyPi](https://pypi.org/project/plantuml-markdown) (📥 650K / month):
	```
...
- [GitHub](https://github.com/PLAYG0N/mkdocs-panzoom) (👨‍💻 4 · 🔀 1 · 📥 34 · 📦 22 · 📋 21 - 14% open · ⏱️ 16.05.2025)
- [PyPi](https://pypi.org/project/mkdocs-panzoom-plugin) (📥 490K / month):
	```
...
<details><summary><b><a href="https://github.com/landmaj/mkdocs-d2-plugin">mkdocs-d2-plugin</a></b>  - 🥈15 ·  ⭐ 31 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>A plugin for embedding D2 diagrams in MkDocs.</summary>

- [GitHub](https://github.com/landmaj/mkdocs-d2-plugin) (👨‍💻 3 · 🔀 6 · 📦 18 · 📋 19 - 5% open · ⏱️ 16.12.2024)
...
- [GitHub](https://github.com/daxcore/mkdocs-obsidian-interactive-graph-plugin) (👨‍💻 2 · 🔀 4 · 📦 49 · ⏱️ 14.12.2024)
...
- [PyPi](https://pypi.org/project/mkdocs-img2fig-plugin) (📥 3.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-badges) (📥 5.4K / month):
	```
...
- [PyPi](https://pypi.org/project/Termage) (📥 17 / month):
	```
	pip install Termage
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/docutools) (📥 86 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-wavedrom-plugin) (📥 68 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bpmn-js) (📥 30 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-thumbnails) (📥 84 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-inline-svg-mod) (📥 400 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-image-formatter-plugin) (📥 42 / month):
	```
...
- [GitHub](https://github.com/pawamoy/markdown-exec) (👨‍💻 4 · 🔀 12 · 📦 540 · 📋 66 - 25% open · ⏱️ 24.03.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-gen-files) (📥 530K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdownextradata-plugin) (📥 96K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 480K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdown-filter) (📥 650 / month):
	```
...
- [PyPi](https://pypi.org/project/mkjsfiddle) (📥 34 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-entangled-plugin) (📥 82 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-data-plugin) (📥 78 / month):
	```
...
<details><summary><b><a href="https://github.com/timvink/mkdocs-git-authors-plugin">git-authors</a></b>  - 🥇26 ·  ⭐ 99 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin to display git authors of a page.</summary>

- [GitHub](https://github.com/timvink/mkdocs-git-authors-plugin) (👨‍💻 17 · 🔀 23 · 📦 1.6K · 📋 65 - 12% open · ⏱️ 10.06.2025)
...
- [PyPi](https://pypi.org/project/mdx-gh-links) (📥 9.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-minify-plugin) (📥 490K / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 📦 71 · ⏱️ 11.06.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-extra-sass-plugin) (📥 7.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-safe-text-plugin) (📥 530 / month):
	```
...
- [GitHub](https://github.com/byrnereese/mkdocs-bootstrap-tables-plugin) (🔀 2 · 📦 96 · ⏱️ 27.03.2020)
...
- [PyPi](https://pypi.org/project/mkdocs-toggle-sidebar-plugin) (📥 3.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swagger-ui-tag) (📥 54K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-coverage) (📥 39K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-asciinema-player) (📥 630 / month):
	```
...
- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 2 · 🔀 4 · 📦 24 · 📋 7 - 71% open · ⏱️ 08.04.2025)
- [PyPi](https://pypi.org/project/mkdocs-llmstxt) (📥 13K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mcp) (📥 23 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vercel-pw-plugin) (📥 23 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-redirects) (📥 830K / month):
	```
...
- [GitHub](https://github.com/shyamd/mkdocs-bibtex) (👨‍💻 18 · 🔀 28 · 📦 400 · 📋 57 - 15% open · ⏱️ 10.06.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-open-in-new-tab) (📥 68K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ezlinks-plugin) (📥 7.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-marker) (📥 490K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-webcontext-plugin) (📥 650 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-issues-plugin) (📥 22 / month):
	```
...
- [GitHub](https://github.com/facelessuser/pymdown-extensions) (👨‍💻 52 · 🔀 260 · 📦 48K · 📋 400 - 2% open · ⏱️ 12.06.2025)
- [PyPi](https://pypi.org/project/pymdown-extensions) (📥 9.5M / month):
	```
...
- [GitHub](https://github.com/oprypin/markdown-callouts) (👨‍💻 2 · 🔀 14 · 📦 450 · 📋 13 - 38% open · ⏱️ 15.02.2025)
- [PyPi](https://pypi.org/project/markdown-callouts) (📥 85K / month):
	```
...
- [GitHub](https://github.com/sondregronas/mkdocs-callouts) (👨‍💻 2 · 🔀 2 · 📦 1.4K · ⏱️ 15.01.2025)
...
- [PyPi](https://pypi.org/project/mdx-truly-sane-lists) (📥 910K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-inline-graphviz-extension) (📥 99K / month):
	```
...
- [PyPi](https://pypi.org/project/kbdextension) (📥 5.3K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-grid-tables) (📥 13K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-tweetable) (📥 14 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-sub-sup) (📥 49 / month):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-nav) (👨‍💻 10 · 🔀 39 · 📦 180 · 📋 100 - 18% open · ⏱️ 18.05.2025)
- [PyPi](https://pypi.org/project/mkdocs-awesome-nav) (📥 91K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gallery) (📥 9.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-live-edit-plugin) (📥 610 / month):
	```
...
- [PyPi](https://pypi.org/project/mkrefs) (📥 25 / month):
	```
	pip install mkrefs
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-vim-md-tags-plugin) (📥 60 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-breadcrumbs-plugin) (📥 640 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-remove-sections-plugin) (📥 22 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-task-collector) (📥 830 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-print-site-plugin) (📥 83K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-with-pdf) (📥 99K / month):
	```
...
- [GitHub](https://github.com/adrienbrignon/mkdocs-exporter) (👨‍💻 4 · 🔀 10 · 📦 35 · 📋 64 - 53% open · ⏱️ 29.10.2024)
- [PyPi](https://pypi.org/project/mkdocs-exporter) (📥 8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pdf-with-js-plugin) (📥 2.1K / month):
	```
...
- [GitHub](https://github.com/backstage/mkdocs-monorepo-plugin) (👨‍💻 32 · 🔀 72 · 📦 550 · 📋 69 - 50% open · ⏱️ 05.06.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-techdocs-core) (📥 580K / month):
	```
...
- [GitHub](https://github.com/ldeluigi/markdown-docs) (👨‍💻 4 · 🔀 6 · 📦 110 · ⏱️ 10.06.2025)
- [Docker Hub](https://hub.docker.com/r/deloo/markdown-docs) (📥 39K · ⏱️ 10.06.2025):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-merge) (📥 4.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-unused-files) (📥 2.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-tagged-files) (📥 79 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-required-frontmatter-plugin) (📥 11 / month):
	```
...
- [GitHub](https://github.com/mondeja/mkdocs-include-markdown-plugin) (👨‍💻 17 · 🔀 23 · 📥 630 · 📦 3K · 📋 89 - 1% open · ⏱️ 07.03.2025)
...
- [GitHub](https://github.com/glennmatthews/markdown-version-annotations) (📥 26 · 📦 62 · ⏱️ 06.05.2024)
...
- [PyPi](https://pypi.org/project/mdx-include) (📥 86K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gitsnippet-plugin) (📥 750 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-snippet-plugin) (📥 800 / month):
	```
