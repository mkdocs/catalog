...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 240 · 🔀 3.1K · 📦 41K · 📋 2.2K - 1% open · ⏱️ 27.12.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-cinder) (📥 6.4K / month):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs-bootswatch) (👨‍💻 10 · 🔀 56 · 📦 1.1K · 📋 33 - 9% open · ⏱️ 27.02.2020)
...
- [GitHub](https://github.com/FernandoCelmer/mkdocs-simple-blog) (👨‍💻 3 · 🔀 4 · 📦 34 · 📋 16 - 37% open · ⏱️ 20.08.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-windmill) (📥 4.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-terminal) (📥 550 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-bootstrap4) (📥 90 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nature) (📥 710 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-risonia-theme) (📥 33 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-moonstone) (📥 41 / month):
	```
...
- [GitHub](https://github.com/Neoteroi/mkdocs-plugins) (👨‍💻 8 · 🔀 7 · 📥 840 · 📦 77 · 📋 32 - 37% open · ⏱️ 24.12.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-typer) (📥 9K / month):
	```
...
- [PyPi](https://pypi.org/project/automacdoc) (📥 29 / month):
	```
...
- [PyPi](https://pypi.org/project/mkautodoc) (📥 6.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mktheapidocs) (📥 300 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-typedoc) (📥 120 / month):
	```
...
- [GitHub](https://github.com/Guts/mkdocs-rss-plugin) (👨‍💻 10 · 🔀 15 · 📥 41 · 📦 360 · 📋 37 - 35% open · ⏱️ 19.12.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-blog-plugin) (📥 2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkblog) (📥 55 / month):
	```
	pip install mkblog
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/plantuml-markdown) (📥 240K / month):
	```
...
- [GitHub](https://github.com/timvink/mkdocs-table-reader-plugin) (👨‍💻 6 · 🔀 14 · 📦 510 · 📋 38 - 5% open · ⏱️ 15.10.2023)
...
<details><summary><b><a href="https://github.com/soulless-viewer/mkdocs-video">MkDocs Video</a></b>  - 🥈16 ·  ⭐ 64 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/512/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs Video plugin.</summary>

- [GitHub](https://github.com/soulless-viewer/mkdocs-video) (👨‍💻 5 · 🔀 11 · 📥 41 · 📦 540 · 📋 16 - 31% open · ⏱️ 17.03.2023)
- [PyPi](https://pypi.org/project/mkdocs-video) (📥 36K / month):
	```
...
<details><summary><b><a href="https://github.com/landmaj/mkdocs-d2-plugin">mkdocs-d2-plugin</a></b>  - 🥉10 ·  ⭐ 5 · 🐣 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/512/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>A plugin for embedding D2 diagrams in MkDocs.</summary>

- [GitHub](https://github.com/landmaj/mkdocs-d2-plugin) (👨‍💻 2 · 🔀 2 · 📦 2 · ⏱️ 22.12.2023)
- [PyPi](https://pypi.org/project/mkdocs-d2-plugin) (📥 550 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-resize-images) (📥 74 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plotly-plugin) (📥 630 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-aafigure) (📥 57 / month):
	```
...
<details><summary><b><a href="https://github.com/ASypula/mkdocs-image-formatter-plugin">image-formatter-plugin</a></b>  - 🥉4 ·  ⭐ 1 · <code>❗Unlicensed</code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/512/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code></summary>
...
- [PyPi](https://pypi.org/project/mkdocs-import-statement-plugin) (📥 59 / month):
	```
...
- [GitHub](https://github.com/rosscdh/mkdocs-markdownextradata-plugin) (👨‍💻 10 · 🔀 17 · 📦 960 · 📋 32 - 18% open · ⏱️ 15.12.2021)
...
- [PyPi](https://pypi.org/project/termynal) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/pheasant) (📥 510 / month):
	```
...
- [PyPi](https://pypi.org/project/mkjsfiddle) (📥 71 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nbconvert) (📥 64 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-localized-plugin) (📥 250K / month):
	```
...
- [GitHub](https://github.com/timvink/mkdocs-git-authors-plugin) (👨‍💻 7 · 🔀 14 · 📦 590 · 📋 50 - 18% open · ⏱️ 04.07.2023)
- [PyPi](https://pypi.org/project/mkdocs-git-authors-plugin) (📥 49K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-plugin) (📥 37K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-latest-changes-plugin) (📥 270 / month):
	```
...
- [GitHub](https://github.com/Python-Markdown/github-links) (👨‍💻 4 · 🔀 9 · 📋 5 - 20% open · ⏱️ 22.12.2023)
- [PyPi](https://pypi.org/project/mdx-gh-links) (📥 8.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-branchcustomization-plugin) (📥 190 / month):
	```
...
<details><summary><b><a href="https://github.com/monosans/mkdocs-minify-html-plugin">minify-html</a></b>  - 🥈14 ·  ⭐ 1 · 🐣 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/512/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin for minification using minify-html, an extremely fast and smart HTML + JS + CSS minifier.</summary>

- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 2 · 📦 10 · ⏱️ 26.12.2023)
- [PyPi](https://pypi.org/project/mkdocs-minify-html-plugin) (📥 3.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap-tables-plugin) (📥 890 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-coverage) (📥 14K / month):
	```
...
<details><summary><b><a href="https://github.com/ultrabug/mkdocs-static-i18n">static-i18n</a></b>  - 🥇23 ·  ⭐ 180 · 📈 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/512/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs i18n plugin using static translation markdown files.</summary>

- [GitHub](https://github.com/ultrabug/mkdocs-static-i18n) (👨‍💻 8 · 🔀 30 · 📦 860 · 📋 120 - 8% open · ⏱️ 22.11.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-roamlinks-plugin) (📥 7.1K / month):
	```
...
- [GitHub](https://github.com/JakubAndrysek/mkdocs-open-in-new-tab) (🔀 1 · 📦 79 · 📋 2 - 50% open · ⏱️ 24.10.2023)
- [PyPi](https://pypi.org/project/mkdocs-open-in-new-tab) (📥 6.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alias-plugin) (📥 390 / month):
	```
...
- [GitHub](https://github.com/theskumar/autolink-references-mkdocs-plugin) (👨‍💻 3 · 🔀 4 · 📦 7 · 📋 4 - 75% open · ⏱️ 22.12.2023)
- [PyPi](https://pypi.org/project/autolink-references-mkdocs-plugin) (📥 4.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-site-urls) (📥 1.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-marker) (📥 360 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-wikilink-plus) (📥 1.4K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-abs-rel-plugin) (📥 820 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ezglossary-plugin) (📥 220 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-webcontext-plugin) (📥 71 / month):
	```
...
- [GitHub](https://github.com/facelessuser/pymdown-extensions) (👨‍💻 44 · 🔀 240 · 📦 27K · 📋 360 - 2% open · ⏱️ 27.12.2023)
...
- [PyPi](https://pypi.org/project/markdown-full-yaml-metadata) (📥 500 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-truly-sane-lists) (📥 170K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-inline-graphviz-extension) (📥 120K / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSuperscript) (📥 560 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-breakless-lists) (📥 9K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-emdash) (📥 160 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 3K / month):
	```
...
- [PyPi](https://pypi.org/project/hbfm) (📥 320 / month):
	```
	pip install hbfm
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#markdown_extensions):
...
- [PyPi](https://pypi.org/project/mdx-cite) (📥 13 / month):
	```
...
- [PyPi](https://pypi.org/project/kbdextension) (📥 97 / month):
	```
...
- [GitHub](https://github.com/unverbuggt/mkdocs-encryptcontent-plugin) (👨‍💻 4 · 🔀 13 · 📥 81 · 📦 930 · 📋 52 - 3% open · ⏱️ 26.12.2023)
...
- [GitHub](https://github.com/tombreit/mkdocs-pagetree-plugin) (📋 4 - 50% open · ⏱️ 22.12.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-include-dir-to-nav) (📥 55K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-file-filter-plugin) (📥 2.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toc-sidebar-plugin) (📥 2.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-enhancements) (📥 2.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-live-edit-plugin) (📥 80 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-schema-reader) (📥 600 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swangallery) (📥 32 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-title-casing-plugin) (📥 77 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-spellcheck) (📥 7.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-localsearch) (📥 2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-tags) (📥 300 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-extract-listings-plugin) (📥 67 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-with-pdf) (📥 28K / month):
	```
...
- [GitHub](https://github.com/timvink/mkdocs-print-site-plugin) (👨‍💻 5 · 🔀 15 · 📦 270 · 📋 83 - 13% open · ⏱️ 25.10.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-zip-folders) (📥 39 / month):
	```
...
- [PyPi](https://pypi.org/project/mike) (📥 160K / month):
	```
	pip install mike
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-multirepo) (📥 97 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yamp) (📥 42 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-unused-files) (📥 260 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-new-features-notifier) (📥 390 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multiple) (📥 790 / month):
	```
...
- [GitHub](https://github.com/prcr/mkdocs-meta-descriptions-plugin) (👨‍💻 3 · 🔀 3 · 📦 920 · 📋 11 - 9% open · ⏱️ 26.12.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-snippet-plugin) (📥 460 / month):
	```
...
- [GitHub](https://github.com/backstage/mkdocs-techdocs-core) (👨‍💻 36 · 🔀 52 · 📦 44 · 📋 49 - 6% open · ⏱️ 24.12.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-no-sitemap-plugin) (📥 1.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-placeholder-plugin) (📥 460 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-badges) (📥 750 / month):
	```
