...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 320 · 🔀 3.8K · 📦 75K · 📋 2.6K - 0% open · ⏱️ 18.10.2025)
...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (🔀 6 · 📥 110 · 📦 17 · 📋 18 - 5% open · ⏱️ 20.10.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-dracula-theme) (📥 4.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-curriculum-vitae) (📥 53 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-custommill) (📥 470 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-cluster) (📥 690 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 4.7M / month):
	```
...
- [PyPi](https://pypi.org/project/mkapi) (📥 8.8K / month):
	```
	pip install mkapi
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
<details><summary><b><a href="https://github.com/tlambert03/mkdocs-api-autonav">mkdocs-api-autonav</a></b>  - 🥈17 ·  ⭐ 29 · <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin for autogenerating API docs with navigation.</summary>

- [GitHub](https://github.com/tlambert03/mkdocs-api-autonav) (👨‍💻 2 · 🔀 1 · 📥 51 · 📦 93 · 📋 15 - 20% open · ⏱️ 25.10.2025)
...
<details><summary><b><a href="https://github.com/watermarkhu/mkdocstrings-matlab">mkdocstrings-matlab</a></b>  - 🥈14 ·  ⭐ 9 · 📈 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code><br>A MATLAB handler for mkdocstrings, automatic documentation from sources.</summary>

- [GitHub](https://github.com/watermarkhu/mkdocstrings-matlab) (👨‍💻 5 · 🔀 1 · 📦 2 · 📋 6 - 33% open · ⏱️ 28.10.2025)
- [PyPi](https://pypi.org/project/mkdocstrings-matlab) (📥 1.1K / month):
	```
...
- [PyPi](https://pypi.org/project/mktheapidocs) (📥 410 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-yaarg-plugin) (📥 40 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-rss-plugin) (📥 140K / month):
	```
...
- [GitHub](https://github.com/mkdocs-publisher/mkdocs-publisher) (👨‍💻 3 · 🔀 9 · 📥 120 · 📦 93 · 📋 31 - 25% open · ⏱️ 11.07.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-newsletter) (📥 400 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mermaid2-plugin) (📥 690K / month):
	```
...
- [GitHub](https://github.com/AVATEAM-IT-SYSTEMHAUS/mkdocs-kroki-plugin) (👨‍💻 16 · 🔀 29 · 📦 71 · 📋 43 - 20% open · ⏱️ 28.07.2024)
...
- [GitHub](https://github.com/PLAYG0N/mkdocs-panzoom) (👨‍💻 7 · 🔀 2 · 📥 36 · 📦 29 · 📋 29 - 17% open · ⏱️ 05.09.2025)
- [PyPi](https://pypi.org/project/mkdocs-panzoom-plugin) (📥 750K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-puml) (📥 46K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-d2-plugin) (📥 22K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-diagrams) (📥 87K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mermaid-plugin) (📥 5K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-captions) (📥 3.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-thumbnails) (📥 60 / month):
	```
...
- [PyPi](https://pypi.org/project/pico8-mkdocs-plugin) (📥 22 / month):
	```
...
- [GitHub](https://github.com/markmap/mkdocs_markmap) (👨‍💻 3 · 🔀 6 · 📥 470 · 📋 34 - 11% open · ⏱️ 11.02.2025)
...
- [PyPi](https://pypi.org/project/termynal) (📥 41K / month):
	```
...
- [GitHub](https://github.com/six-two/mkdocs-placeholder-plugin) (👨‍💻 2 · 🔀 3 · 📦 14 · 📋 10 - 10% open · ⏱️ 28.10.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-nbconvert) (📥 780 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-data-plugin) (📥 230 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-enumerate-headings-plugin) (📥 35K / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 📦 73 · ⏱️ 30.10.2025)
- [PyPi](https://pypi.org/project/mkdocs-minify-html-plugin) (📥 48K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-embeds-plugin) (📥 440 / month):
	```
...
<details><summary><b><a href="https://github.com/pawamoy/mkdocs-llmstxt">mkdocs-llmstxt</a></b>  - 🥇20 ·  ⭐ 82 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin to generate an /llms.txt file (https://llmstxt.org/).</summary>

- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 4 · 🔀 9 · 📦 88 · 📋 19 - 31% open · ⏱️ 03.10.2025)
- [PyPi](https://pypi.org/project/mkdocs-llmstxt) (📥 82K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-render-swagger-plugin) (📥 98K / month):
	```
...
<details><summary><b><a href="https://github.com/ubaumann/mkdocs-mcp">mkdocs-mcp</a></b>  - 🥉9 ·  ⭐ 6 · 🐣 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs Plugin to serve MCP.</summary>
...
- [GitHub](https://github.com/manuzhang/mkdocs-htmlproofer-plugin) (👨‍💻 15 · 🔀 15 · 📦 570 · 📋 37 - 10% open · ⏱️ 27.10.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-autorefs) (📥 4.5M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-unused-files) (📥 5.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-argref-plugin) (📥 690 / month):
	```
...
- [GitHub](https://github.com/facelessuser/pymdown-extensions) (👨‍💻 55 · 🔀 270 · 📦 50K · 📋 410 - 3% open · ⏱️ 25.10.2025)
...
- [PyPi](https://pypi.org/project/markdown-callouts) (📥 79K / month):
	```
...
- [PyPi](https://pypi.org/project/MarkdownSubscript) (📥 720 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 480K / month):
	```
...
- [PyPi](https://pypi.org/project/asciimathml) (📥 680 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-emdash) (📥 100 / month):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-nav) (👨‍💻 10 · 🔀 39 · 📦 320 · 📋 120 - 19% open · ⏱️ 10.09.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-simple-hooks) (📥 93K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-categories-plugin) (📥 1.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-breadcrumbs-plugin) (📥 2.3K / month):
	```
...
<details><summary><b><a href="https://github.com/pawamoy/mkdocs-spellcheck">mkdocs-spellcheck</a></b>  - 🥇18 ·  ⭐ 23 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>A spell checker plugin for MkDocs.</summary>

- [GitHub](https://github.com/pawamoy/mkdocs-spellcheck) (👨‍💻 4 · 🔀 5 · 📦 80 · 📋 26 - 34% open · ⏱️ 05.08.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-linkcheck) (📥 26K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-code-validator) (📥 360 / month):
	```
...
- [GitHub](https://github.com/timvink/mkdocs-print-site-plugin) (👨‍💻 15 · 🔀 28 · 📋 110 - 10% open · ⏱️ 03.08.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-autozip) (📥 50 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-monorepo-plugin) (📥 2.2M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multirepo-plugin) (📥 80K / month):
	```
...
- [GitHub](https://github.com/ldeluigi/markdown-docs) (👨‍💻 6 · 🔀 6 · 📦 110 · ⏱️ 20.10.2025)
...
- [GitHub](https://github.com/virtualguard101/mkdocs-note) (👨‍💻 2 · 🔀 1 · 📋 19 - 21% open · ⏱️ 30.10.2025)
- [PyPi](https://pypi.org/project/mkdocs-note) (📥 2.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-new-features-notifier) (📥 180 / month):
	```
