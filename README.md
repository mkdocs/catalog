...
- [GitHub](https://github.com/squidfunk/mkdocs-material) (👨‍💻 220 · 🔀 2.9K · 📦 36K · 📋 2K - 1% open · ⏱️ 24.08.2023)
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 2.8M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-cinder) (📥 4.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootswatch) (📥 9.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-terminal) (📥 600 / month):
	```
...
<details><summary><b><a href="https://github.com/dracula/mkdocs">Dracula</a></b>  - 🥈14 ·  ⭐ 20 · 🐣 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1495/PNG/512/preferencesdesktoptheme_102980.png" style="display:inline;" width="13" height="13"></code><br>Dark theme for Mkdocs.</summary>

- [GitHub](https://github.com/dracula/mkdocs) (👨‍💻 3 · 🔀 2 · 📦 10 · 📋 6 - 16% open · ⏱️ 09.07.2023)
- [PyPi](https://pypi.org/project/mkdocs-dracula-theme) (📥 520 / month):
	```
...
- [PyPi](https://pypi.org/project/lantana) (📥 260 / month):
	```
	pip install lantana
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
...
- [PyPi](https://pypi.org/project/mkdocs-kpn) (📥 860 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-bootstrap4) (📥 80 / month):
	```
...
- [GitHub](https://github.com/unverbuggt/mkdocs-risonia-theme) (⏱️ 19.08.2023)
- [PyPi](https://pypi.org/project/mkdocs-risonia-theme) (📥 290 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-zettelkasten) (📥 48 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swan) (📥 75 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-moonstone) (📥 89 / month):
	```
...
- [GitHub](https://github.com/mkdocstrings/mkdocstrings) (👨‍💻 37 · 🔀 94 · 📦 8.8K · 📋 350 - 13% open · ⏱️ 21.08.2023)
...
- [GitHub](https://github.com/Neoteroi/mkdocs-plugins) (👨‍💻 7 · 🔀 6 · 📥 320 · 📦 30 · 📋 23 - 26% open · ⏱️ 28.07.2023)
...
- [GitHub](https://github.com/fralau/mkdocs-mermaid2-plugin) (👨‍💻 13 · 🔀 22 · 📦 1.5K · 📋 56 - 5% open · ⏱️ 09.08.2023)
...
<details><summary><b><a href="https://github.com/timvink/mkdocs-table-reader-plugin">table-reader</a></b>  - 🥇23 ·  ⭐ 85 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/512/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin that enables a markdown tag like {{ read_csv(table.csv) }} to directly insert various table formats into..</summary>

- [GitHub](https://github.com/timvink/mkdocs-table-reader-plugin) (👨‍💻 6 · 🔀 11 · 📦 320 · 📋 37 - 10% open · ⏱️ 09.06.2023)
- [PyPi](https://pypi.org/project/mkdocs-table-reader-plugin) (📥 65K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-kroki-plugin) (📥 10K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-charts-plugin) (📥 3.9K / month):
	```
...
- [GitHub](https://github.com/quantorconsulting/mkdocs_build_plantuml) (👨‍💻 7 · 🔀 12 · 📦 86 · 📋 18 - 22% open · ⏱️ 04.12.2022)
...
- [PyPi](https://pypi.org/project/mkdocs-plotly-plugin) (📥 740 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-wavedrom-plugin) (📥 12 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-figcap) (📥 47 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-import-statement-plugin) (📥 99 / month):
	```
...
<details><summary><b><a href="https://github.com/pawamoy/markdown-exec">markdown-exec</a></b>  - 🥈14 ·  ⭐ 50 · <code><a href="http://bit.ly/3hkKRql">ISC</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/512/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Utilities to execute code blocks in Markdown files.</summary>

- [GitHub](https://github.com/pawamoy/markdown-exec) (👨‍💻 2 · 🔀 4 · 📦 73 · 📋 23 - 39% open · ⏱️ 14.06.2023)
- [PyPi](https://pypi.org/project/markdown-exec) (📥 10K / month):
	```
...
- [PyPi](https://pypi.org/project/mkjsfiddle) (📥 54 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nbconvert) (📥 40 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-markdown-filter) (📥 210 / month):
	```
...
- [GitHub](https://github.com/ojacques/mkdocs-git-committers-plugin-2) (👨‍💻 6 · 🔀 10 · 📦 250 · 📋 17 - 41% open · ⏱️ 06.08.2023)
...
- [GitHub](https://github.com/Python-Markdown/github-links) (👨‍💻 3 · 🔀 8 · 📦 96 · ⏱️ 31.07.2023)
- [PyPi](https://pypi.org/project/mdx-gh-links) (📥 4.5K / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 2 · 📦 10 · ⏱️ 22.08.2023)
- [PyPi](https://pypi.org/project/mkdocs-minify-html-plugin) (📥 870 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-add-number-plugin) (📥 830 / month):
	```
...
<details><summary><b><a href="https://github.com/blueswen/mkdocs-swagger-ui-tag">MkDocs Swagger UI Tag</a></b>  - 🥇17 ·  ⭐ 39 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/512/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>A MkDocs plugin supports for add Swagger UI in page.</summary>

- [GitHub](https://github.com/blueswen/mkdocs-swagger-ui-tag) (👨‍💻 2 · 🔀 5 · 📥 26 · 📦 68 · 📋 12 - 25% open · ⏱️ 09.08.2023)
...
- [PyPi](https://pypi.org/project/foliantcontrib.mkdocs) (📥 290 / month):
	```
...
- [GitHub](https://github.com/ultrabug/mkdocs-static-i18n) (👨‍💻 8 · 🔀 26 · 📦 670 · 📋 97 - 13% open · ⏱️ 24.08.2023)
- [PyPi](https://pypi.org/project/mkdocs-static-i18n) (📥 15K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-autorefs) (📥 560K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-roamlinks-plugin) (📥 4.6K / month):
	```
...
- [GitHub](https://github.com/JakubAndrysek/mkdocs-open-in-new-tab) (🔀 1 · 📦 40 · ⏱️ 24.05.2023)
- [PyPi](https://pypi.org/project/mkdocs-open-in-new-tab) (📥 3.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-alias-plugin) (📥 320 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-site-urls) (📥 670 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-abs-rel-plugin) (📥 950 / month):
	```
...
- [GitHub](https://github.com/facelessuser/pymdown-extensions) (👨‍💻 43 · 🔀 240 · 📦 23K · 📋 340 - 2% open · ⏱️ 22.08.2023)
...
- [PyPi](https://pypi.org/project/python-markdown-math) (📥 36K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-callouts) (📥 9.3K / month):
	```
...
- [GitHub](https://github.com/sondregronas/mkdocs-callouts) (👨‍💻 2 · 🔀 1 · 📦 610 · ⏱️ 25.01.2023)
...
- [PyPi](https://pypi.org/project/mdx-breakless-lists) (📥 2.6K / month):
	```
...
- [PyPi](https://pypi.org/project/hbfm) (📥 150 / month):
	```
	pip install hbfm
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#markdown_extensions):
...
- [PyPi](https://pypi.org/project/markdown-del-ins) (📥 350 / month):
	```
...
- [GitHub](https://github.com/lukasgeiter/mkdocs-awesome-pages-plugin) (👨‍💻 7 · 🔀 29 · 📦 3K · 📋 63 - 19% open · ⏱️ 19.08.2023)
...
- [GitHub](https://github.com/unverbuggt/mkdocs-encryptcontent-plugin) (👨‍💻 4 · 🔀 11 · 📥 76 · 📦 630 · 📋 42 - 4% open · ⏱️ 24.08.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-simple-hooks) (📥 21K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swangallery) (📥 57 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-file-filter-plugin) (📥 2.5K / month):
	```
...
- [GitHub](https://github.com/EddyLuten/mkdocs-categories-plugin) (📦 10 · ⏱️ 23.06.2023)
- [PyPi](https://pypi.org/project/mkdocs-categories-plugin) (📥 240 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-live-edit-plugin) (📥 66 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-weight) (📥 420 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-enhancements) (📥 4.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toc-sidebar-plugin) (📥 590 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-schema-reader) (📥 430 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-copy) (📥 16 / month):
	```
...
- [PyPi](https://pypi.org/project/mktestdocs) (📥 5.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-code-validator) (📥 100 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-search) (📥 8.7K / month):
	```
...
- [GitHub](https://github.com/orzih/mkdocs-with-pdf) (👨‍💻 6 · 🔀 62 · 📦 370 · 📋 98 - 55% open · ⏱️ 14.10.2021)
...
- [GitHub](https://github.com/zhaoterryy/mkdocs-pdf-export-plugin) (👨‍💻 11 · 🔀 42 · 📦 480 · 📋 87 - 47% open · ⏱️ 05.10.2021)
...
- [PyPi](https://pypi.org/project/mkdocs-helm) (📥 16 / month):
	```
...
- [GitHub](https://github.com/jdoiro3/mkdocs-multirepo-plugin) (👨‍💻 11 · 🔀 27 · 📦 82 · 📋 72 - 41% open · ⏱️ 28.07.2023)
- [PyPi](https://pypi.org/project/mkdocs-multirepo-plugin) (📥 19K / month):
	```
...
- [GitHub](https://github.com/athackst/mkdocs-simple-plugin) (👨‍💻 8 · 🔀 11 · 📦 39 · ⏱️ 24.08.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-merge) (📥 630 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-tagged-files) (📥 48 / month):
	```
...
- [GitHub](https://github.com/prcr/mkdocs-meta-descriptions-plugin) (👨‍💻 3 · 🔀 3 · 📦 610 · 📋 11 - 9% open · ⏱️ 23.08.2023)
...
- [GitHub](https://github.com/fire1ce/mkdocs-embed-external-markdown) (👨‍💻 4 · 🔀 5 · 📦 95 · ⏱️ 27.06.2023)
...
- [PyPi](https://pypi.org/project/mkdocs-same-dir) (📥 8.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-no-sitemap-plugin) (📥 480 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bibtex) (📥 3.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-badges) (📥 780 / month):
	```
