...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (🔀 8 · 📥 120 · 📦 24 · 📋 19 - 5% open · ⏱️ 27.11.2025)
- [PyPi](https://pypi.org/project/mkdocs-shadcn) (📥 7K / month):
	```
...
- [PyPi](https://pypi.org/project/lantana) (📥 110 / month):
	```
	pip install lantana
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#theme):
...
- [PyPi](https://pypi.org/project/mkdocs-kpn) (📥 290 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-custommill) (📥 580 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-landing) (📥 110 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-github) (📥 250 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-moonstone) (📥 840 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-risonia-theme) (📥 32 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-python) (📥 9.5M / month):
	```
...
- [GitHub](https://github.com/Neoteroi/mkdocs-plugins) (👨‍💻 13 · 🔀 12 · 📥 16K · 📦 450 · 📋 44 - 43% open · ⏱️ 23.11.2025)
...
- [GitHub](https://github.com/JakubAndrysek/MkDoxy) (👨‍💻 18 · 🔀 31 · 📦 50 · 📋 69 - 27% open · ⏱️ 29.08.2025)
...
- [GitHub](https://github.com/tlambert03/mkdocs-api-autonav) (👨‍💻 2 · 🔀 1 · 📥 59 · 📦 110 · 📋 16 - 25% open · ⏱️ 25.10.2025)
- [PyPi](https://pypi.org/project/mkdocs-api-autonav) (📥 74K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-crystal) (📥 29K / month):
	```
...
- [GitHub](https://github.com/syn54x/mkdocs-typer2) (🔀 1 · 📦 14 · ⏱️ 02.09.2025)
...
- [GitHub](https://github.com/watermarkhu/mkdocstrings-matlab) (👨‍💻 5 · 🔀 1 · 📥 6 · 📦 2 · 📋 6 - 33% open · ⏱️ 30.11.2025)
...
- [PyPi](https://pypi.org/project/automacdoc) (📥 93 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-apidescribed-plugin) (📥 200 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-pipeline-visualizer) (📥 25 / month):
	```
...
- [PyPi](https://pypi.org/project/ansible-mkdocs) (📥 45 / month):
	```
...
- [GitHub](https://github.com/Guts/mkdocs-rss-plugin) (👨‍💻 20 · 🔀 30 · 📥 380 · 📋 61 - 22% open · ⏱️ 01.12.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-glightbox) (📥 880K / month):
	```
...
- [GitHub](https://github.com/AVATEAM-IT-SYSTEMHAUS/mkdocs-kroki-plugin) (👨‍💻 18 · 🔀 29 · 📦 76 · 📋 44 - 2% open · ⏱️ 04.12.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-mermaid2-plugin) (📥 790K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-d2-plugin) (📥 24K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bpmn-js) (📥 1.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-thumbnails) (📥 42 / month):
	```
...
- [GitHub](https://github.com/pawamoy/markdown-exec) (👨‍💻 6 · 🔀 16 · 📦 620 · 📋 66 - 21% open · ⏱️ 11.11.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-gen-files) (📥 790K / month):
	```
...
- [PyPi](https://pypi.org/project/mknotebooks) (📥 35K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-marimo) (📥 5.8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkjsfiddle) (📥 330 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-plugin) (📥 230K / month):
	```
...
- [GitHub](https://github.com/jaywhj/mkdocs-document-dates) (👨‍💻 3 · 🔀 3 · 📦 12 · ⏱️ 04.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-document-dates) (📥 2.5K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-latest-changes-plugin) (📥 8.7K / month):
	```
...
<details><summary><b><a href="https://github.com/jaywhj/mkdocs-recently-updated-docs">recently-updated</a></b>  - 🥉11 ·  ⭐ 7 · 🐣 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>Display a list of recently updated documents anywhere on your MkDocs site with a single line of code.</summary>

- [GitHub](https://github.com/jaywhj/mkdocs-recently-updated-docs) (⏱️ 02.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-recently-updated-docs) (📥 190 / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 📦 74 · ⏱️ 04.12.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-add-teaser) (📥 430 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-toggle-sidebar-plugin) (📥 5.6K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-render-swagger-plugin) (📥 94K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-copy-to-llm) (📥 360 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mdpo-plugin) (📥 79 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ezglossary-plugin) (📥 11K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-tooltipster-links-plugin) (📥 41 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-webcontext-plugin) (📥 78 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 340K / month):
	```
...
- [PyPi](https://pypi.org/project/asciimathml) (📥 780 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-sub-sup) (📥 390 / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticdata) (📥 59 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-nav-weight) (📥 30K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-vim-md-tags-plugin) (📥 41 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-authors-plugin) (📥 17 / month):
	```
...
- [GitHub](https://github.com/adrienbrignon/mkdocs-exporter) (👨‍💻 4 · 🔀 14 · 📦 41 · 📋 69 - 55% open · ⏱️ 29.10.2024)
...
- [PyPi](https://pypi.org/project/mkdocs-autozip) (📥 49 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-note) (📥 800 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-required-frontmatter-plugin) (📥 200 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-no-sitemap-plugin) (📥 5.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-snippet-plugin) (📥 930 / month):
	```
