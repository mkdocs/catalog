...
- [PyPi](https://pypi.org/project/mkdocs-material) (📥 13M / month):
	```
...
- [GitHub](https://github.com/asiffer/mkdocs-shadcn) (👨‍💻 2 · 🔀 12 · 📥 130 · 📦 41 · 📋 22 - 9% open · ⏱️ 03.02.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-windmill) (📥 6.9K / month):
	```
...
<details><summary><b><a href="https://github.com/dracula/mkdocs">Dracula</a></b>  - 🥈16 ·  ⭐ 110 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1495/PNG/32/preferencesdesktoptheme_102980.png" style="display:inline;" width="13" height="13"></code><br>Dark theme for Mkdocs.</summary>
...
- [PyPi](https://pypi.org/project/mkdocs-dracula-theme) (📥 5.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-torillic) (📥 440 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-curriculum-vitae) (📥 150 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-custommill) (📥 410 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-risonia-theme) (📥 84 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-moonstone) (📥 310 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-bootstrap386) (📥 840 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-theme-topdf) (📥 42 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings) (📥 5.8M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocstrings-python) (📥 8.6M / month):
	```
...
- [GitHub](https://github.com/daizutabi/mkapi) (👨‍💻 6 · 🔀 18 · 📦 250 · 📋 150 - 2% open · ⏱️ 05.02.2026)
- [PyPi](https://pypi.org/project/mkapi) (📥 8.2K / month):
	```
	pip install mkapi
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdoxy) (📥 40K / month):
	```
	pip install mkdoxy
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
<details><summary><b><a href="https://github.com/tlambert03/mkdocs-api-autonav">mkdocs-api-autonav</a></b>  - 🥈16 ·  ⭐ 39 · <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin for autogenerating API docs with navigation.</summary>

- [GitHub](https://github.com/tlambert03/mkdocs-api-autonav) (👨‍💻 2 · 🔀 2 · 📥 59 · 📦 150 · 📋 16 - 18% open · ⏱️ 09.01.2026)
...
<details><summary><b><a href="https://github.com/mkdocstrings/crystal">mkdocstrings-crystal</a></b>  - 🥈14 ·  ⭐ 31 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code><br>Crystal language doc generator for https://github.com/mkdocstrings/mkdocstrings.</summary>
...
- [PyPi](https://pypi.org/project/mkdocs-autoapi) (📥 27K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-typer2) (📥 8K / month):
	```
...
- [GitHub](https://github.com/watermarkhu/mkdocstrings-matlab) (👨‍💻 5 · 🔀 1 · 📥 8 · 📦 2 · 📋 7 - 42% open · ⏱️ 03.02.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-pipeline-visualizer) (📥 88 / month):
	```
...
- [PyPi](https://pypi.org/project/ansible-mkdocs) (📥 40 / month):
	```
...
- [PyPi](https://pypi.org/project/plantuml-markdown) (📥 1.6M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-glightbox) (📥 1M / month):
	```
...
<details><summary><b><a href="https://github.com/AVATEAM-IT-SYSTEMHAUS/mkdocs-kroki-plugin">kroki</a></b>  - 🥇25 ·  ⭐ 60 · 📈 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>MkDocs plugin for Kroki-Diagrams.</summary>

- [GitHub](https://github.com/AVATEAM-IT-SYSTEMHAUS/mkdocs-kroki-plugin) (👨‍💻 18 · 🔀 29 · 📦 86 · ⏱️ 12.01.2026)
...
- [GitHub](https://github.com/fralau/mkdocs-mermaid2-plugin) (👨‍💻 16 · 🔀 30 · 📦 3.4K · 📋 87 - 17% open · ⏱️ 17.10.2025)
- [PyPi](https://pypi.org/project/mkdocs-mermaid2-plugin) (📥 1.5M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-build-plantuml-plugin) (📥 60K / month):
	```
...
- [GitHub](https://github.com/MikhailKravets/mkdocs_puml) (👨‍💻 9 · 🔀 16 · 📦 77 · 📋 34 - 29% open · ⏱️ 04.08.2025)
- [PyPi](https://pypi.org/project/mkdocs-puml) (📥 71K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-table-reader-plugin) (📥 160K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-video) (📥 140K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-d2-plugin) (📥 25K / month):
	```
...
<details><summary><b><a href="https://github.com/daxcore/mkdocs-obsidian-interactive-graph-plugin">Interactive Graph</a></b>  - 🥈14 ·  ⭐ 34 · <code><a href="http://bit.ly/34MBwT8">MIT</a></code> · <code><img src="https://cdn.icon-icons.com/icons2/1465/PNG/32/701electricplug_100845.png" style="display:inline;" width="13" height="13"></code><br>interactive graph for Material for MkDocs like Obsidian, refer demo:.</summary>

- [GitHub](https://github.com/daxcore/mkdocs-obsidian-interactive-graph-plugin) (👨‍💻 3 · 🔀 6 · 📦 52 · 📋 6 - 16% open · ⏱️ 10.11.2025)
- [PyPi](https://pypi.org/project/mkdocs-obsidian-interactive-graph-plugin) (📥 380 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-captions) (📥 8.5K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-svgbob) (📥 780 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-graphviz) (📥 9.8K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-figcap) (📥 64 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-plugin-inline-svg-mod) (📥 630 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-image-formatter-plugin) (📥 50 / month):
	```
...
- [GitHub](https://github.com/pawamoy/markdown-exec) (👨‍💻 6 · 🔀 16 · 📦 700 · 📋 67 - 22% open · ⏱️ 06.01.2026)
...
- [PyPi](https://pypi.org/project/mknotebooks) (📥 30K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-marimo) (📥 5.7K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-meta-manager) (📥 700K / month):
	```
...
- [PyPi](https://pypi.org/project/termynal) (📥 52K / month):
	```
...
- [GitHub](https://github.com/six-two/mkdocs-placeholder-plugin) (👨‍💻 2 · 🔀 3 · 📦 19 · 📋 10 - 10% open · ⏱️ 28.10.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-data-plugin) (📥 480 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-localized-plugin) (📥 1.4M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-authors-plugin) (📥 330K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-git-revision-date-plugin) (📥 780K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-recently-updated-docs) (📥 200 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-minify-plugin) (📥 740K / month):
	```
...
- [GitHub](https://github.com/monosans/mkdocs-minify-html-plugin) (👨‍💻 4 · 🔀 1 · 📦 91 · ⏱️ 04.02.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-enumerate-headings-plugin) (📥 43K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-link-embeds-plugin) (📥 270 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-safe-text-plugin) (📥 680 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-ai-summary) (📥 93 / month):
	```
...
- [GitHub](https://github.com/pawamoy/mkdocs-llmstxt) (👨‍💻 5 · 🔀 11 · 📦 220 · ⏱️ 01.12.2025)
- [PyPi](https://pypi.org/project/mkdocs-llmstxt) (📥 160K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-swagger-ui-tag) (📥 140K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-asciinema-player) (📥 2.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-render-swagger-plugin) (📥 100K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-mcp) (📥 45 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-licenseinfo) (📥 95 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-redirects) (📥 1.9M / month):
	```
...
- [GitHub](https://github.com/manuzhang/mkdocs-htmlproofer-plugin) (👨‍💻 15 · 🔀 16 · 📦 630 · 📋 38 - 7% open · ⏱️ 23.01.2026)
...
- [PyPi](https://pypi.org/project/mkdocs-autorefs) (📥 5.6M / month):
	```
...
- [GitHub](https://github.com/OctoPrint/mkdocs-site-urls) (👨‍💻 2 · 🔀 4 · 📦 71 · 📋 5 - 40% open · ⏱️ 04.09.2025)
...
- [PyPi](https://pypi.org/project/mkdocs-link-marker) (📥 700K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-backlinks-section-plugin) (📥 2K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-wikilink-plus) (📥 5.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-tooltipster-links-plugin) (📥 99 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-argref-plugin) (📥 520 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-addresses) (📥 450 / month):
	```
...
- [PyPi](https://pypi.org/project/pymdown-extensions) (📥 17M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-callouts) (📥 43K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-truly-sane-lists) (📥 2.7M / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-breakless-lists) (📥 21K / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-katex) (📥 450K / month):
	```
...
- [PyPi](https://pypi.org/project/kbdextension) (📥 390 / month):
	```
...
- [PyPi](https://pypi.org/project/markdown-grid-tables) (📥 37K / month):
	```
...
- [PyPi](https://pypi.org/project/mdx-semanticwikilinks) (📥 19 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-awesome-nav) (📥 190K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-gallery) (📥 8K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-live-edit-plugin) (📥 240 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-breadcrumbs-plugin) (📥 2.9K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-authors-plugin) (📥 21 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-schema-reader) (📥 3.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-navsorted-plugin) (📥 190 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-remove-sections-plugin) (📥 20 / month):
	```
...
- [GitHub](https://github.com/pawamoy/mkdocs-spellcheck) (👨‍💻 7 · 🔀 6 · 📦 84 · ⏱️ 03.02.2026)
- [PyPi](https://pypi.org/project/mkdocs-spellcheck) (📥 58K / month):
	```
...
<details><summary><b><a href="https://github.com/koaning/mktestdocs">mktestdocs</a></b>  - 🥈13 ·  ⭐ 160 · <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code><br>Run pytest against markdown files/docstrings.</summary>
...
- [PyPi](https://pypi.org/project/mkdocs-linkcheck) (📥 24K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-code-validator) (📥 570 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-task-collector) (📥 130 / month):
	```
...
- [GitHub](https://github.com/adrienbrignon/mkdocs-exporter) (👨‍💻 4 · 🔀 16 · 📦 47 · 📋 70 - 55% open · ⏱️ 29.10.2024)
...
- [PyPi](https://pypi.org/project/mkdocs-helm) (📥 55 / month):
	```
...
- [GitHub](https://github.com/jimporter/mike) (👨‍💻 9 · 🔀 50 · 📥 430 · 📦 5.5K · 📋 200 - 7% open · ⏱️ 03.12.2025)
- [PyPi](https://pypi.org/project/mike) (📥 950K / month):
	```
	pip install mike
	```
- Add to [mkdocs.yml](https://www.mkdocs.org/user-guide/configuration/#plugins):
...
- [PyPi](https://pypi.org/project/mkdocs-techdocs-core) (📥 1.6M / month):
	```
...
- [GitHub](https://github.com/backstage/mkdocs-monorepo-plugin) (👨‍💻 32 · 🔀 76 · 📦 610 · 📋 75 - 54% open · ⏱️ 15.06.2025)
- [PyPi](https://pypi.org/project/mkdocs-monorepo-plugin) (📥 2.4M / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-simple-plugin) (📥 50K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-versioning) (📥 7.3K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-same-dir) (📥 73K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-exclude-unused-files) (📥 6.2K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-note) (📥 380 / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-multiple) (📥 570 / month):
	```
...
- [GitHub](https://github.com/prcr/mkdocs-meta-descriptions-plugin) (👨‍💻 3 · 🔀 2 · 📦 1.2K · 📋 12 - 8% open · ⏱️ 04.02.2026)
...
- [GitHub](https://github.com/glennmatthews/markdown-version-annotations) (📥 26 · 📦 90 · ⏱️ 06.05.2024)
...
- [PyPi](https://pypi.org/project/mdx-include) (📥 180K / month):
	```
...
- [PyPi](https://pypi.org/project/mkdocs-snippet-plugin) (📥 950 / month):
	```
